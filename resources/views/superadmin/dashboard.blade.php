...
<head>
    ...
    <title>{{ $pageTitle ?? 'SuperAdmin Dashboard' }} - FlorenceEGI</title>
    @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>

<body class="bg-base-200">
    <div class="flex min-h-screen">
        {{-- Sidebar SuperAdmin con tema ORO --}}
        ...
        <main class="flex-1 p-8">
            ...
            <div class="grid grid-cols-1 gap-6 mb-8 md:grid-cols-2 lg:grid-cols-4">
                {{-- AI Consultations --}}
                <div class="text-white shadow-xl card bg-gradient-to-br from-yellow-500 to-amber-600">
                    <div class="card-body">
                ...
                {{-- Total EGIs --}}
                <div class="text-white shadow-xl card bg-gradient-to-br from-blue-500 to-indigo-600">
                    <div class="card-body">
                        <div class="flex items-center justify-between">
                            <div>
                ...
                {{-- Active Users --}}
                <div class="text-white shadow-xl card bg-gradient-to-br from-green-500 to-emerald-600">
                    <div class="card-body">
                        <div class="flex items-center justify-between">
                            <div>
                ...
                {{-- Traits Created --}}
                <div class="text-white shadow-xl card bg-gradient-to-br from-purple-500 to-pink-600">
                    <div class="card-body">
                        <div class="flex items-center justify-between">
                            <div>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                    <a href="{{ route('superadmin.ai.consultations.index') }}" class="shadow-lg btn btn-primary btn-lg">
                    ...
                    <a href="{{ route('superadmin.ai.credits.index') }}" class="shadow-lg btn btn-accent btn-lg">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('superadmin.egili.index') }}" class="shadow-lg btn btn-warning btn-lg">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                            <path fill-rule="evenodd"
