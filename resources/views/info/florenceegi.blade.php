...
<head>
    ...
    <link rel="canonical" href="{{ url('/info/florenceegi') }}">
    ...
    <meta property="og:url" content="{{ url('/info/florenceegi') }}">
    ...
    {{-- Vite React App --}}
    @vite(['resources/react/florenceegi-info/main.tsx'])
</head>
...
<body>
    ...
    {{-- React mount point --}}
    <div id="root" role="main" aria-label="FlorenceEGI Informative Page"></div>
