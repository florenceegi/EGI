            ...
            <section id="glossario" class="mt-16 fade-in">
                ...
                <div class="p-8 bg-white shadow-lg rounded-2xl">
                    <dl class="space-y-8">
                        ...
                        <div>
                            <dt id="glossary-egili" class="text-xl font-bold text-emerald-700">EGILI (Crediti di Servizio Interni)
                            </dt>
                            <dd class="mt-1 text-gray-700">Crediti di servizio interni di FlorenceEGI, non trasferibili, non rimborsabili e privi di valore monetario autonomo. Si ottengono in due modi: (1) acquistando pacchetti di servizi AI in valuta <a href="#glossary-fiat" class="glossary-link">FIAT</a> (EUR), che accreditano Egili sul proprio account; (2) attraverso il sistema di premiazione per merito (attività sulla piattaforma, vendite, referral, partecipazione community). Utilizzabili per: servizi AI della piattaforma, riduzione o azzeramento delle fee, sconti su servizi. <strong>Non sono token</strong>, non sono quotati su exchange, non sono convertibili in denaro. Classificati come <strong>crediti di servizio prepagati</strong>, fuori dal perimetro <a href="#glossary-mica" class="glossary-link">MiCA</a>. Modello analogo ai crediti SaaS (es. crediti OpenAI, AWS credits).</dd>
                        </div>
                        <div>
        ...
        const contentData = {
            ...
            pagamenti: {
                ...
                content: '<div class="p-6 mb-8 border-l-4 rounded-r-lg bg-emerald-50 border-emerald-500 text-emerald-800">' +
                    ...
                    '<div class="p-6 border rounded-lg bg-gray-50"><h3 class="mb-4 text-2xl font-bold text-gray-800">Sistema Egili — Crediti di Servizio e Premiazione Interna</h3><p class="mb-6 text-gray-600">Un sistema di crediti interni che combina l\'accesso ai servizi AI della piattaforma con un programma di premiazione per merito. Gli Egili <strong>non sono token</strong>, non hanno valore monetario autonomo e non possono essere utilizzati per acquistare <a href="#glossary-egi" class="glossary-link">EGI</a>.</p><div class="grid gap-6 md:grid-cols-2"><div><h4 class="mb-2 text-lg font-semibold text-emerald-800">Come si Ottengono</h4><ul class="space-y-2 text-gray-700 list-disc list-inside"><li><strong>Acquisto pacchetti AI:</strong> L\'utente acquista pacchetti di servizi AI in valuta <a href="#glossary-fiat" class="glossary-link">FIAT</a> (EUR) tramite <a href="#glossary-psp" class="glossary-link">PSP</a> autorizzati. L\'acquisto accredita Egili sul proprio account.</li><li><strong>Premiazione per merito:</strong> Egili assegnati come ricompensa per attività meritevoli (vendite, referral verificati, partecipazione community, contributi EPP).</li></ul></div><div><h4 class="mb-2 text-lg font-semibold text-emerald-800">Come si Utilizzano</h4><ul class="space-y-2 text-gray-700 list-disc list-inside"><li><strong>Servizi AI:</strong> Utilizzo di N.A.T.A.N. e altri servizi AI della piattaforma. Gli Egili vengono scalati proporzionalmente al consumo.</li><li><strong>Riduzione fee:</strong> Applicazione di sconti parziali o azzeramento delle commissioni di piattaforma.</li><li><strong>Sconti servizi:</strong> Accesso a condizioni privilegiate su servizi e funzionalità premium.</li></ul></div></div>' +
                    '<details class="collapsible-section"><summary><span class="text-xl material-icons">stars</span> Il Sistema Egili nel Dettaglio</summary><div class="collapsible-content">' +
                    '<h5 class="mt-4 mb-3 text-lg font-semibold text-gray-800">Cosa sono gli Egili?</h5>' +
                    '<p class="mb-4 text-gray-700"><strong><a href="#glossary-egili" class="glossary-link">Egili</a></strong> sono <strong>crediti di servizio interni</strong> di FlorenceEGI con le seguenti caratteristiche:</p>' +
                    '<ul class="mb-4 space-y-1 text-gray-700 list-disc list-inside"><li><strong>Non sono token:</strong> Non sono asset digitali, non sono crypto-asset, non sono utility token.</li><li><strong>Non trasferibili:</strong> Non possono essere scambiati, ceduti o trasferiti tra utenti.</li><li><strong>Non rimborsabili:</strong> Una volta accreditati, non sono convertibili in denaro.</li><li><strong>Privi di valore monetario autonomo:</strong> Non hanno un tasso di cambio con valute FIAT o crypto.</li><li><strong>Account-bound:</strong> Legati all\'account utente, non a un <a href="#glossary-wallet" class="glossary-link">wallet</a> crypto.</li></ul>' +
                    '<h5 class="mt-6 mb-3 text-lg font-semibold text-gray-800">Come si Ottengono gli Egili?</h5>' +
                    '<p class="mb-2 text-gray-700"><strong>1. Acquisto pacchetti servizi AI (FIAT):</strong></p>' +
                    '<ul class="mb-4 space-y-1 text-gray-700 list-disc list-inside"><li>L\'utente sceglie un pacchetto di servizi AI dalla piattaforma.</li><li>Il pagamento avviene esclusivamente in valuta FIAT (EUR) tramite <a href="#glossary-psp" class="glossary-link">PSP</a> regolamentati (Stripe/PayPal).</li><li>Il pacchetto acquistato accredita un determinato numero di Egili sul saldo dell\'utente.</li><li>Il modello è analogo ai crediti prepagati di servizi SaaS (es. crediti OpenAI, AWS credits).</li></ul>' +
                    '<p class="mb-2 text-gray-700"><strong>2. Premiazione per merito (Reward):</strong></p>' +
                    '<ul class="mb-4 space-y-1 text-gray-700 list-disc list-inside"><li><strong>Volume vendite:</strong> Creator e Trader Pro guadagnano Egili proporzionali alle vendite generate.</li><li><strong>Referral verificati:</strong> Bonus per nuovi utenti portati che completano il KYC.</li><li><strong>Contributi EPP volontari:</strong> Bonus aggiuntivo per donazioni ambientali.</li><li><strong>Partecipazione community:</strong> Eventi, feedback costruttivi, contributi alla piattaforma.</li><li><strong>Milestone:</strong> Obiettivi raggiunti (es. numero di vendite, durata iscrizione).</li></ul>' +
                    '<h5 class="mt-6 mb-3 text-lg font-semibold text-gray-800">Come si Utilizzano gli Egili?</h5>' +
                    '<div class="space-y-3 text-gray-700"><ol class="space-y-2 list-decimal list-inside"><li><strong>Servizi AI:</strong> Ogni interazione con i servizi AI della piattaforma (N.A.T.A.N., analisi, valutazioni) consuma Egili in proporzione alle risorse utilizzate. Al termine degli Egili, il servizio si interrompe fino a nuovo acquisto o accredito.</li><li><strong>Riduzione fee:</strong> Gli Egili possono essere utilizzati per ridurre o azzerare le commissioni di piattaforma su vendite e acquisti.</li><li><strong>Sconti servizi:</strong> Accesso a condizioni privilegiate su funzionalità premium, strumenti avanzati e servizi dedicati.</li></ol></div>' +
                    '<h5 class="mt-6 mb-3 text-lg font-semibold text-gray-800">Cosa NON si può fare con gli Egili</h5>' +
                    '<ul class="mb-4 space-y-1 text-gray-700 list-disc list-inside"><li><strong>NON</strong> possono essere usati per acquistare <a href="#glossary-egi" class="glossary-link">EGI</a> (gli EGI si pagano esclusivamente in FIAT).</li><li><strong>NON</strong> possono essere trasferiti ad altri utenti.</li><li><strong>NON</strong> possono essere convertiti in denaro o criptovalute.</li><li><strong>NON</strong> possono essere venduti o scambiati su exchange.</li><li><strong>NON</strong> rappresentano un investimento o un asset finanziario.</li></ul>' +
                    '<div class="p-4 mt-6 border-l-4 border-green-600 rounded-lg bg-green-50"><h5 class="mb-2 font-semibold text-green-900">Conformità Normativa <a href="#glossary-mica-safe" class="glossary-link">MiCA-safe</a></h5><p class="text-sm text-green-800">Gli <a href="#glossary-egili" class="glossary-link">Egili</a> <strong>NON sono crypto-asset</strong> ai sensi del Regolamento <a href="#glossary-mica" class="glossary-link">MiCA</a> perché: non sono trasferibili, non sono convertibili in denaro, non hanno valore monetario autonomo, non sono scambiabili su mercati secondari. Sono classificati come <strong>crediti di servizio prepagati</strong>, analoghi ai crediti di piattaforme SaaS. FlorenceEGI opera pertanto <strong>fuori dal perimetro MiCA</strong> per questa funzionalità, senza necessità di licenza CASP/EMI. Il pagamento avviene sempre in FIAT tramite PSP regolamentati.</p></div></div></details></div>' +
                    '<div class="p-6 border rounded-lg bg-gray-50">' +
                    '<details class="collapsible-section"><summary><span class="text-xl material-icons">key_off</span> Riscatto Wallet — Trasferimento EGI al Wallet Personale</summary><div class="collapsible-content"><p class="mb-4 text-gray-700">L\'utente che desidera ottenere la <strong>piena proprietà</strong> dei propri <a href="#glossary-egi" class="glossary-link">EGI</a> può richiedere il <strong>riscatto del wallet</strong>. Questa operazione trasferisce gli <a href="#glossary-asa" class="glossary-link">ASA</a> (Algorand Standard Asset) dal <a href="#glossary-wallet" class="glossary-link">wallet</a> <a href="#glossary-custodial" class="glossary-link">custodiale</a> della piattaforma al wallet personale dell\'utente, consegnandogli contestualmente la <a href="#glossary-mnemonic" class="glossary-link">frase segreta (seed phrase)</a>.</p>' +
                    '<h5 class="mt-6 mb-3 text-lg font-semibold text-gray-800">Perché è richiesto un pagamento?</h5>' +
                    '<p class="mb-4 text-gray-700">La <a href="#glossary-blockchain" class="glossary-link">blockchain</a> Algorand richiede che ogni <a href="#glossary-wallet" class="glossary-link">wallet</a> che intende ricevere un <a href="#glossary-asa" class="glossary-link">ASA</a> effettui preventivamente un\'operazione chiamata <strong><a href="#glossary-opt-in" class="glossary-link">opt-in</a></strong>. Questa operazione blocca temporaneamente <strong>0,1 <a href="#glossary-algo" class="glossary-link">ALGO</a></strong> per ogni ASA che il wallet intende detenere. Tale importo non viene speso ma resta vincolato come requisito di bilancio minimo imposto dal protocollo Algorand, e viene liberato qualora l\'utente decida in futuro di rimuovere l\'ASA dal proprio wallet (operazione di <strong>opt-out</strong>).</p>' +
                    '<div class="p-4 my-4 border-l-4 border-amber-500 rounded-lg bg-amber-50"><h5 class="mb-2 font-semibold text-amber-900">Formula di calcolo del costo</h5><p class="text-sm text-amber-800">Il costo totale del riscatto è determinato dalla seguente formula:</p><p class="mt-2 font-mono text-sm text-amber-900"><strong>Costo = (N × 0,1 ALGO) + 0,1 ALGO + fee di rete</strong></p><p class="mt-2 text-sm text-amber-800">Dove <strong>N</strong> è il numero di <a href="#glossary-egi" class="glossary-link">EGI</a> posseduti dall\'utente. Il secondo addendo (0,1 ALGO) rappresenta il bilancio minimo richiesto per mantenere attivo l\'account Algorand, mentre le fee di rete coprono le transazioni di opt-in e trasferimento (circa 0,001 ALGO ciascuna).</p></div>' +
                    '<h5 class="mt-6 mb-3 text-lg font-semibold text-gray-800">Esempio pratico</h5>' +
                    '<p class="mb-4 text-gray-700">Un utente che possiede <strong>50 EGI</strong> dovrà sostenere un costo di circa:</p>' +
                    '<ul class="mb-4 space-y-1 text-gray-700 list-disc list-inside"><li>50 × 0,1 ALGO = <strong>5 ALGO</strong> (per gli opt-in)</li><li>0,1 ALGO (bilancio minimo account)</li><li>~0,1 ALGO (fee di rete per ~100 transazioni)</li><li><strong>Totale: ~5,2 ALGO</strong></li></ul>' +
                    '<p class="mb-4 text-gray-700">Al cambio corrente (1 ALGO ≈ 0,12 €), questo equivale a circa <strong>0,62 €</strong>. L\'importo viene addebitato in valuta <a href="#glossary-fiat" class="glossary-link">FIAT</a> (EUR) tramite <a href="#glossary-psp" class="glossary-link">PSP</a>, oppure scalato dal saldo <a href="#glossary-egili" class="glossary-link">Egili</a> dell\'utente se disponibile.</p>' +
                    '<h5 class="mt-6 mb-3 text-lg font-semibold text-gray-800">Flusso operativo del riscatto</h5>' +
                    '<div class="space-y-3 text-gray-700"><ol class="space-y-2 list-decimal list-inside"><li><strong>Richiesta:</strong> L\'utente avvia la procedura di riscatto dalla propria <a href="#glossary-dashboard" class="glossary-link">dashboard</a> e visualizza il costo calcolato.</li><li><strong>Pagamento:</strong> L\'importo viene addebitato in FIAT tramite PSP, oppure scalato dal saldo <a href="#glossary-egili" class="glossary-link">Egili</a> se disponibile.</li><li><strong>Funding:</strong> La piattaforma trasferisce gli <a href="#glossary-algo" class="glossary-link">ALGO</a> necessari dal <a href="#glossary-treasury" class="glossary-link">Treasury</a> al <a href="#glossary-wallet" class="glossary-link">wallet</a> dell\'utente.</li><li><strong>Opt-in automatico:</strong> Il sistema esegue automaticamente l\'<a href="#glossary-opt-in" class="glossary-link">opt-in</a> per ogni <a href="#glossary-asa" class="glossary-link">ASA</a> di proprietà dell\'utente, firmando le transazioni con la chiave privata ancora in custodia.</li><li><strong>Trasferimento ASA:</strong> Gli <a href="#glossary-egi" class="glossary-link">EGI</a> vengono trasferiti dal Treasury al <a href="#glossary-wallet" class="glossary-link">wallet</a> personale dell\'utente.</li><li><strong>Consegna seed phrase:</strong> L\'utente visualizza la propria <a href="#glossary-mnemonic" class="glossary-link">frase segreta</a> (25 parole) e conferma di averla salvata in modo sicuro.</li><li><strong>Cancellazione:</strong> La frase segreta cifrata viene <strong>eliminata definitivamente</strong> dal database di FlorenceEGI.</li></ol></div>' +
                    '<div class="p-4 mt-6 border-l-4 border-blue-600 rounded-lg bg-blue-50"><h5 class="mb-2 font-semibold text-blue-900">Politica Zero-Profitto</h5><p class="text-sm text-blue-800">FlorenceEGI <strong>non applica alcun margine o commissione</strong> sull\'operazione di riscatto. Il costo addebitato all\'utente copre esclusivamente le spese imposte dalla <a href="#glossary-blockchain" class="glossary-link">blockchain</a> Algorand (requisiti di bilancio minimo e fee di transazione). Questa politica è coerente con la missione della piattaforma di facilitare l\'accesso alla certificazione digitale senza barriere economiche aggiuntive.</p></div>' +
                    '<div class="p-4 mt-4 border-l-4 border-green-600 rounded-lg bg-green-50"><h5 class="mb-2 font-semibold text-green-900">Dopo il riscatto</h5><p class="text-sm text-green-800">Una volta completato il riscatto, il <a href="#glossary-wallet" class="glossary-link">wallet</a> diventa <strong>completamente <a href="#glossary-non-custodial" class="glossary-link">non-custodial</a></strong>. L\'utente è l\'unico detentore delle chiavi private e può gestire i propri <a href="#glossary-egi" class="glossary-link">EGI</a> tramite qualsiasi client Algorand compatibile (Pera Wallet, Defly, etc.). FlorenceEGI non ha più alcun controllo né visibilità sugli asset trasferiti, se non per quanto riguarda la registrazione storica delle transazioni sulla <a href="#glossary-blockchain" class="glossary-link">blockchain</a> pubblica.</p></div></div></details></div>' +
                    '</div>' +
                    '<div class="mt-8">' +
