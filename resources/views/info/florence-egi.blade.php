    ...
    <main>
        <section id="visione" class="text-white hero-background"
            ...
            <div class="px-4 py-16 golden-ratio-container sm:px-6 sm:py-24">
                <div class="max-w-5xl mx-auto text-center">
                    ...
                    <div class="max-w-4xl mx-auto mb-8 text-lg font-body">{{ __('info_florence_egi.hero.description') }}
                    </div>
            ...
            <div class="px-4 golden-ratio-container sm:px-6">
                        ...
                        <div class="relative">
                            <div class="absolute transform -translate-x-1/2 -top-16 left-1/2">
                                <div class="trilemma-point bg-viola-innovazione">
                                    <div><i class="mb-2 text-2xl fas fa-palette"></i><br>{!!
                                        __('info_florence_egi.problem.trilemma_quality') !!}</div>
                                </div>
                            </div>
                            <div class="absolute -left-16 top-32">
                                <div class="trilemma-point bg-blu-algoritmo">
                                    <div><i class="mb-2 text-2xl fas fa-chart-line"></i><br>{!!
                                        __('info_florence_egi.problem.trilemma_liquidity') !!}</div>
                                </div>
                            </div>
                            <div class="absolute -right-16 top-32">
                                <div class="trilemma-point bg-verde-rinascita">
                                    <div><i class="mb-2 text-2xl fas fa-leaf"></i><br>{!!
                                        __('info_florence_egi.problem.trilemma_impact') !!}</div>
                                </div>
                            </div>
                            <div
                                class="flex items-center justify-center w-32 h-32 font-bold text-center text-white rounded-full bg-rosso-urgenza">
                                <div><i class="mb-2 text-3xl fas fa-times"></i><br>{!!
                                    __('info_florence_egi.problem.trilemma_impossible') !!}</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="grid gap-8 mb-16 md:grid-cols-3">
                    <div class="p-6 text-center renaissance-card">
                        <div class="flex items-center justify-center w-16 h-16 mx-auto mb-4 bg-gray-100 rounded-full"><i
                                class="text-2xl fas fa-times text-rosso-urgenza"></i></div>
                        ...
                        <p class="text-sm font-body text-grigio-pietra">{!!
                            __('info_florence_egi.problem.competitor_opensea_desc') !!}</p>
                    </div>
                    <div class="p-6 text-center renaissance-card">
                        <div class="flex items-center justify-center w-16 h-16 mx-auto mb-4 bg-gray-100 rounded-full"><i
                                class="text-2xl fas fa-times text-rosso-urgenza"></i></div>
                        ...
                        <p class="text-sm font-body text-grigio-pietra">{!!
                            __('info_florence_egi.problem.competitor_blur_desc') !!}</p>
                    </div>
                    <div class="p-6 text-center renaissance-card">
                        <div class="flex items-center justify-center w-16 h-16 mx-auto mb-4 bg-gray-100 rounded-full"><i
                                class="text-2xl fas fa-times text-rosso-urgenza"></i></div>
                        ...
                        <p class="text-sm font-body text-grigio-pietra">{!!
                            __('info_florence_egi.problem.competitor_foundation_desc') !!}</p>
                    </div>
                </div>
            </div>
        </section>

        <section id="egi" class="py-16 bg-gray-50 sm:py-24" aria-label="{{ __('info_florence_egi.egi.aria_label') }}">
            <div class="px-4 golden-ratio-container sm:px-6">
                <div class="mb-12 text-center sm:mb-16">
                    <h2 class="mb-4 text-3xl font-bold renaissance-title text-grigio-pietra sm:text-4xl md:text-5xl">{!!
                        __('info_florence_egi.egi.title_html') !!}</h2>
                    <p class="max-w-3xl mx-auto text-xl font-body text-grigio-pietra">{!!
                        __('info_florence_egi.egi.subtitle_html') !!}</p>
                </div>
                <div class="grid gap-8 mb-16 md:grid-cols-3">
                    <div class="p-8 renaissance-card elegant-hover">
                        <div class="flex items-center justify-center mb-6">
                            <div class="flex items-center justify-center w-20 h-20 rounded-full bg-verde-rinascita/20">
                                <i class="text-3xl fas fa-seedling text-verde-rinascita"></i></div>
                        </div>
                        <h3 class="mb-4 text-xl font-bold text-center renaissance-title">
                            {{ __('info_florence_egi.egi.card1_title') }}</h3>
                        <p class="text-center font-body text-grigio-pietra">{{ __('info_florence_egi.egi.card1_desc') }}
                        </p>
                    </div>
                    <div class="p-8 renaissance-card elegant-hover">
                        <div class="flex items-center justify-center mb-6">
                            <div class="flex items-center justify-center w-20 h-20 rounded-full bg-oro-fiorentino/20"><i
                                    class="text-3xl fas fa-box text-oro-fiorentino"></i></div>
                        </div>
                        <h3 class="mb-4 text-xl font-bold text-center renaissance-title">
                            {{ __('info_florence_egi.egi.card2_title') }}</h3>
                        <p class="text-center font-body text-grigio-pietra">{{ __('info_florence_egi.egi.card2_desc') }}
                        </p>
                    </div>
                    <div class="p-8 renaissance-card elegant-hover">
                        <div class="flex items-center justify-center mb-6">
                            <div
                                ...
                                <i class="text-3xl fas fa-lightbulb text-viola-innovazione"></i></div>
                        </div>
                        <h3 class="mb-4 text-xl font-bold text-center renaissance-title">
                            {{ __('info_florence_egi.egi.card3_title') }}</h3>
                        <p class="text-center font-body text-grigio-pietra">{{ __('info_florence_egi.egi.card3_desc') }}
                        </p>
                    </div>
                </div>
                    ...
                    <div class="grid items-center gap-8 md:grid-cols-2">
                        ...
                        <div class="text-center">
                            <div
                                ...
                                <i class="text-4xl fas fa-handshake text-oro-fiorentino"></i></div>
                    ...
                    <div
                        ...
                        <div class="flex items-center mb-6">
                            <div
                                ...
                                <i class="text-2xl fas fa-gem text-viola-innovazione"></i></div>
                    ...
                    <div
                        ...
                        <div class="flex items-center mb-6">
                            <div
                                ...
                                <i class="text-2xl fas fa-bolt text-blu-algoritmo"></i></div>
                            <h3 class="text-2xl font-bold renaissance-title">
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-center mb-6">
                            <div
                                ...
                                <i class="text-2xl fas fa-infinity text-verde-rinascita"></i></div>
                            <h3 class="text-2xl font-bold renaissance-title">
                ...
                <div class="mt-16">
                    ...
                    <div class="grid gap-8 md:grid-cols-3">
                        <div class="p-6 text-center renaissance-card"><i
                            ...
                            <p class="text-sm font-body text-grigio-pietra">{{ __('info_florence_egi.tech.sc1_desc') }}
                            </p>
                        </div>
                        <div class="p-6 text-center renaissance-card"><i
                            ...
                            <p class="text-sm font-body text-grigio-pietra">{{ __('info_florence_egi.tech.sc2_desc') }}
                            </p>
                        </div>
                        <div class="p-6 text-center renaissance-card"><i
                            ...
                            <p class="text-sm font-body text-grigio-pietra">{{ __('info_florence_egi.tech.sc3_desc') }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid gap-8 mb-16 lg:grid-cols-2">
                    <div
                        ...
                        <div class="flex items-center mb-6">
                            <div
                                ...
                                <i class="text-2xl fas fa-certificate text-oro-fiorentino"></i></div>
                            <h3 class="text-2xl font-bold renaissance-title">
                    ...
                    <div
                        ...
                        <div class="flex items-center mb-6">
                            <div
                                class="flex items-center justify-center w-16 h-16 mr-4 rounded-full bg-blu-algoritmo/20">
                                <i class="text-2xl fas fa-building text-blu-algoritmo"></i></div>
                            <h3 class="text-2xl font-bold renaissance-title">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start space-x-4">
                            <div
                                ...
                                1</div>
                            <div class="font-body">
                                <h4 class="text-lg font-semibold">{{ __('info_florence_egi.coa.workflow1_title') }}</h4>
                        ...
                        <div class="flex items-start space-x-4">
                            <div
                                ...
                                2</div>
                            <div class="font-body">
                                <h4 class="text-lg font-semibold">{{ __('info_florence_egi.coa.workflow2_title') }}</h4>
                        ...
                        <div class="flex items-start space-x-4">
                            <div
                                ...
                                3</div>
                            <div class="font-body">
                                <h4 class="text-lg font-semibold">{{ __('info_florence_egi.coa.workflow3_title') }}</h4>
                        ...
                        <div class="flex items-start space-x-4">
                            <div
                                ...
                                4</div>
                            <div class="font-body">
                                <h4 class="text-lg font-semibold">{{ __('info_florence_egi.coa.workflow4_title') }}</h4>
        ...
        <section id="gdpr" class="py-16 text-white section-dark sm:py-24">
            <div class="px-4 golden-ratio-container sm:px-6">
                ...
                <div class="grid gap-8 lg:grid-cols-2">
                    <div
                        ...
                        <div class="flex items-center mb-6">
                            <div
                                class="flex items-center justify-center w-16 h-16 mr-4 rounded-full bg-oro-fiorentino/20">
                                <i class="text-2xl fas fa-shield-alt text-oro-fiorentino"></i></div>
                    ...
                    <div
                        ...
                        <div class="flex items-center mb-6">
                            <div
                                class="flex items-center justify-center w-16 h-16 mr-4 rounded-full bg-verde-rinascita/20">
                                <i class="text-2xl fas fa-cogs text-verde-rinascita"></i></div>
                            <h3 class="text-xl font-bold renaissance-title">
                ...
                <div class="mt-12">
                    <h3 class="mb-8 text-2xl font-bold text-center renaissance-title">{!!
                        __('info_florence_egi.gdpr.rights_title_html') !!}</h3>
                    ...
                    <div
                        ...
                        <div class="text-center">
                            <h3 class="mb-6 text-2xl font-bold renaissance-title">{!!
                                __('info_florence_egi.gdpr.ultra_title_html') !!}</h3>
                            ...
                            <div class="grid gap-4 md:grid-cols-3">
                                <div class="text-center"><i
                                    ...
                                    <p class="text-sm text-green-100">{{ __('info_florence_egi.gdpr.ultra1_desc') }}</p>
                                </div>
                                <div class="text-center"><i
                                    ...
                                    <p class="text-sm text-green-100">{{ __('info_florence_egi.gdpr.ultra2_desc') }}</p>
                                </div>
                                <div class="text-center"><i
                                        class="mb-2 text-2xl fas fa-chart-line text-rosso-urgenza"></i>
                                    <h4 class="font-bold">{{ __('info_florence_egi.gdpr.ultra3_title') }}</h4>
                                    <p class="text-sm text-green-100">{{ __('info_florence_egi.gdpr.ultra3_desc') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                    <a href="{{ route('info.creator') }}"
                        ...
                        <div
                            ...
                            <i class="text-2xl fas fa-brush text-viola-innovazione"></i></div>
                    ...
                    <a href="{{ route('archetypes.collector') }}"
                        ...
                        <div
                            ...
                            <i class="text-2xl fas fa-gem text-oro-fiorentino"></i></div>
                        <h3 class="mb-2 text-lg font-bold renaissance-title text-grigio-pietra">
                    ...
                    <a href="{{ route('archetypes.patron') }}"
                        ...
                        <div
                            ...
                            <i class="text-2xl fas fa-heart text-rosso-urgenza"></i></div>
                        <h3 class="mb-2 text-lg font-bold renaissance-title text-grigio-pietra">
                    ...
                    <a href="{{ route('info.epp') }}"
                        ...
                        <div
                            ...
                            <i class="text-2xl fas fa-seedling text-verde-rinascita"></i></div>
                        <h3 class="mb-2 text-lg font-bold renaissance-title text-grigio-pietra">
                    ...
                    <a href="{{ route('archetypes.pa-entity') }}"
                        ...
                        <div
                            ...
                            <i class="text-2xl fas fa-university text-arancio-energia"></i></div>
                        <h3 class="mb-2 text-lg font-bold renaissance-title text-grigio-pietra">
                            {{ __('info_florence_egi.archetypes.pa_title') }}</h3>
                        <p class="text-sm font-body text-grigio-pietra">{{ __('info_florence_egi.archetypes.pa_desc') }}
                        </p>
                    </a>
                    <a href="{{ route('info.trader-pro') }}"
                        ...
                        <div
                            class="flex items-center justify-center w-16 h-16 mx-auto mb-4 rounded-full bg-viola-innovazione/10">
                            <i class="text-2xl fas fa-chart-line text-viola-innovazione"></i></div>
                        <h3 class="mb-2 text-lg font-bold renaissance-title text-grigio-pietra">
                ...
                <div class="grid gap-8 mb-16 md:grid-cols-3">
                    <div
                        ...
                        <div class="flex items-center mb-6">
                            <div
                                class="flex items-center justify-center w-16 h-16 mr-4 rounded-full bg-verde-rinascita/20">
                                <i class="text-2xl fas fa-tree text-verde-rinascita"></i></div>
                            <h3 class="text-xl font-bold renaissance-title">
                    ...
                    <div
                        ...
                        <div class="flex items-center mb-6">
                            <div
                                class="flex items-center justify-center w-16 h-16 mr-4 rounded-full bg-blu-algoritmo/20">
                                <i class="text-2xl fas fa-water text-blu-algoritmo"></i></div>
                            <h3 class="text-xl font-bold renaissance-title">
                    ...
                    <div
                        ...
                        <div class="flex items-center mb-6">
                            <div
                                class="flex items-center justify-center w-16 h-16 mr-4 rounded-full bg-oro-fiorentino/20">
                                <i class="text-2xl fas fa-bee text-oro-fiorentino"></i></div>
                            <h3 class="text-xl font-bold renaissance-title">
                    ...
                    <div
                        ...
                        <div class="mt-6"><a href="{{ route('info.epp') }}"
                                class="inline-flex items-center px-6 py-3 text-white transition-all rounded-lg bg-viola-innovazione hover:bg-viola-innovazione/80"><i
                                    class="mr-2 fas fa-seedling"></i> {{ __('info_florence_egi.impact.cta') }}</a></div>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="grid gap-8 mb-16 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="p-8 renaissance-card elegant-hover">
                        <div class="flex items-center mb-6">
                            <div
                                class="flex items-center justify-center w-16 h-16 mr-4 rounded-full bg-viola-innovazione/20">
                                <i class="text-2xl fas fa-palette text-viola-innovazione"></i></div>
                            <h3 class="text-xl font-bold renaissance-title">
                    ...
                    <div class="p-8 renaissance-card elegant-hover">
                        <div class="flex items-center mb-6">
                            <div
                                class="flex items-center justify-center w-16 h-16 mr-4 rounded-full bg-oro-fiorentino/20">
                                <i class="text-2xl fas fa-lightbulb text-oro-fiorentino"></i></div>
                            <h3 class="text-xl font-bold renaissance-title">
                    ...
                    <div class="p-8 renaissance-card elegant-hover">
                        <div class="flex items-center mb-6">
                            <div
                                class="flex items-center justify-center w-16 h-16 mr-4 rounded-full bg-blu-algoritmo/20">
                                <i class="text-2xl fas fa-shield-alt text-blu-algoritmo"></i></div>
                            <h3 class="text-xl font-bold renaissance-title">
                    ...
                    <div class="p-8 renaissance-card elegant-hover">
                        <div class="flex items-center mb-6">
                            <div
                                ...
                                <i class="text-2xl fas fa-exchange-alt text-rosso-urgenza"></i></div>
                            <h3 class="text-xl font-bold renaissance-title">
                    ...
                    <div class="p-8 renaissance-card elegant-hover">
                        <div class="flex items-center mb-6">
                            <div
                                ...
                                <i class="text-2xl fas fa-balance-scale text-arancio-energia"></i></div>
                            <h3 class="text-xl font-bold renaissance-title">
                    ...
                    <div class="grid gap-8 lg:grid-cols-2">
                        <div class="p-8 renaissance-card elegant-hover">
                            <div class="flex items-center mb-6">
                                <div
                                    class="flex items-center justify-center w-16 h-16 mr-4 rounded-full bg-oro-fiorentino/20">
                                    <i class="text-2xl fas fa-atom text-oro-fiorentino"></i></div>
                                <h3 class="text-xl font-bold renaissance-title">
                            ...
                            <p class="font-body text-grigio-pietra">{{ __('info_florence_egi.equilibrium.card1_p2') }}
                            </p>
                        </div>
                        <div class="p-8 renaissance-card elegant-hover">
                            <div class="flex items-center mb-6">
                            ...
                            <p class="font-body text-grigio-pietra">{{ __('info_florence_egi.equilibrium.card2_p2') }}
                            </p>
                        </div>
                        <div class="p-8 renaissance-card elegant-hover lg:col-span-2">
                            <div class="flex items-center justify-center mb-6">
                                <div
                                    class="flex items-center justify-center w-16 h-16 mr-4 rounded-full bg-blu-algoritmo/20">
                                    <i class="text-2xl fas fa-heart text-blu-algoritmo"></i></div>
                                <h3 class="text-xl font-bold renaissance-title">
                                    {{ __('info_florence_egi.equilibrium.card3_title') }}</h3>
                            </div>
                            <p class="max-w-4xl mx-auto text-center font-body text-grigio-pietra">{!! __('info_florence_egi.equilibrium.card3_p1') !!}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="px-4 golden-ratio-container sm:px-6">
                <div class="max-w-4xl mx-auto text-center">
                    ...
                    <p class="mb-8 text-xl font-body text-grigio-pietra">
                        <em>"{{ __('info_florence_egi.cta.quote') }}"</em></p>
                    <div class="flex flex-col gap-4 sm:flex-row sm:justify-center">
