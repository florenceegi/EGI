...
<body class="bg-gray-50 pt-20 text-grigio-pietra">
        ...
        <div class="golden-ratio-container px-4 py-4 sm:px-6 sm:py-6">
            <div class="flex items-center justify-between">
                ...
                <nav class="hidden space-x-3 md:flex">
                    ...
                    <a href="#gdpr"
                        class="hover:text-oro-fiorentino font-body text-sm transition lg:text-base">GDPR</a>
                    <a href="#archetipi"
                        class="hover:text-oro-fiorentino font-body text-sm transition lg:text-base">Archetipi</a>
                    <a href="#valori"
                        class="hover:text-oro-fiorentino font-body text-sm transition lg:text-base">Valori</a>
                    <a href="#equilibrium"
                        class="hover:text-oro-fiorentino font-body text-sm transition lg:text-base">Equilibrium</a>
                </nav>
            ...
            <div id="mobile-menu" class="mt-4 hidden border-t border-blue-600 pb-4 md:hidden">
                <div class="space-y-3 pt-4">
                    ...
                    <a href="#valori"
                        class="flex items-center rounded-md px-4 py-2 text-sm transition-colors hover:bg-blue-700">
                        <i class="fas fa-heart text-oro-fiorentino mr-3 text-lg"></i>
                        Valori
                    </a>
                    <a href="#equilibrium"
                        class="flex items-center rounded-md px-4 py-2 text-sm transition-colors hover:bg-blue-700">
                        <i class="fas fa-atom text-oro-fiorentino mr-3 text-lg"></i>
                        Equilibrium
                    </a>
                </div>
            </div>
        ...
        <div class="golden-ratio-container px-4 sm:px-6">
            ...
            <div class="mb-16 grid gap-8 md:grid-cols-3">
                <div class="renaissance-card elegant-hover p-8">
                    ...
                    <h3 class="renaissance-title mb-4 text-center text-xl font-bold">Environment Protection Programs
                    </h3>
                ...
                <div class="renaissance-card elegant-hover p-8">
                    ...
                    <h3 class="renaissance-title mb-4 text-center text-xl font-bold">Goods - Beni o Servizi</h3>
                    <p class="text-center font-body text-grigio-pietra">
                ...
                <div class="renaissance-card elegant-hover p-8">
                    <div class="mb-6 flex items-center justify-center">
                        <div class="flex h-20 w-20 items-center justify-center rounded-full bg-viola-innovazione/20">
                            <i class="fas fa-lightbulb text-3xl text-viola-innovazione"></i>
                        </div>
                    </div>
                    <h3 class="renaissance-title mb-4 text-center text-xl font-bold">Inventive - Creatività</h3>
                    <p class="text-center font-body text-grigio-pietra">
                ...
                <div
                    ...
                    <div class="space-y-4 font-body text-green-100">
                        <div class="flex items-start">
                            <i class="fas fa-check-circle mr-3 mt-1 text-verde-rinascita"></i>
                            <div>
                                <h4 class="font-semibold text-white">Sistema di Ruoli e Permessi a Due Livelli</h4>
                                <p>Autorizzazioni granulari basate su Spatie Laravel Permission per controllo accessi
                                    preciso</p>
                            </div>
                        </div>
                        <div class="flex items-start">
            ...
            <div class="mt-12">
                ...
                <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                    <div
                        ...
                        <h4 class="mb-2 font-bold">Diritto di Accesso</h4>
                    ...
                    <div
                        ...
                        <h4 class="mb-2 font-bold">Portabilità Dati</h4>
                    ...
                    <div
                        ...
                        <h4 class="mb-2 font-bold">Limitazione Trattamento</h4>
                    ...
                    <div
                        ...
                        <h4 class="mb-2 font-bold">Diritto all'Oblio</h4>
                ...
                <div
                    ...
                    <div class="text-center">
                        ...
                        <div class="grid gap-4 md:grid-cols-3">
                            <div class="text-center">
                                <i class="fas fa-clipboard-list text-oro-fiorentino mb-2 text-2xl"></i>
                                <h4 class="font-bold">Audit Trail</h4>
                                <p class="text-sm text-green-100">Ogni azione tracciata</p>
                            </div>
                            <div class="text-center">
                                <i class="fas fa-exclamation-triangle mb-2 text-2xl text-verde-rinascita"></i>
                                <h4 class="font-bold">Error Handling</h4>
                                <p class="text-sm text-green-100">Gestione sicura degli errori</p>
                            </div>
                            <div class="text-center">
                                <i class="fas fa-chart-line mb-2 text-2xl text-rosso-urgenza"></i>
            ...
            <div class="mb-16 grid gap-8 md:grid-cols-3">
                <div
                    ...
                    <div class="space-y-2 font-body">
                        ...
                        <p class="text-sm text-verde-rinascita"><i class="fas fa-exclamation-triangle mr-1"></i>Ogni
                ...
                <div
                    ...
                    <div class="space-y-2 font-body">
                        ...
                        <p class="text-sm text-blu-algoritmo"><i
                                class="fas fa-exclamation-triangle mr-1"></i>Emergenza plastica acquatica</p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="space-y-2 font-body">
                        ...
                        <p class="text-oro-fiorentino text-sm"><i class="fas fa-check mr-1"></i>Un terzo del cibo
                            dipende dalle api</p>
                    </div>
                </div>
            </div>
    ...
    <section id="valori" class="bg-gray-50 py-16 sm:py-24">
        <div class="golden-ratio-container px-4 sm:px-6">
            ...
            <div class="mb-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="renaissance-card elegant-hover p-8">
                    <div class="mb-6 flex items-center">
                        <div class="mr-4 flex h-16 w-16 items-center justify-center rounded-full bg-rosso-urgenza/20">
                ...
                <div class="renaissance-card elegant-hover p-8">
                    <div class="mb-6 flex items-center">
                        ...
                        <h3 class="renaissance-title text-xl font-bold">Equilibrio tra Ambiente, Economia e Società
                        </h3>
                    </div>
                    <p class="font-body text-grigio-pietra">
    ...
    <!-- L'Equilibrium -->
    <section id="equilibrium" class="from-oro-fiorentino/10 bg-gradient-to-br to-verde-rinascita/10 py-16 sm:py-24">
        <div class="golden-ratio-container px-4 sm:px-6">
