...
<x-guest-layout title="{{ __('info.why_cant_buy_egis_info.page_title') }}" :noHero="false">
                ...
                <div class="mx-auto max-w-4xl text-center">
                    ...
                    <nav aria-label="{{ __('info.why_cant_buy_egis_info.breadcrumb_aria') }}" class="mb-8">
                        <ol class="flex justify-center space-x-2 text-sm text-gray-400">
                            ...
                            <li class="text-white" aria-current="page">{{ __('info.why_cant_buy_egis_info.page_title') }}
                            </li>
                        </ol>
                    </nav>
    ...
    @slot('heroNatanAssistant')
        ...
        {{-- @include('components.natan-assistant') --}} {{-- DISABLED TEMPORARILY --}}
    @endslot
        ...
        <div class="container mx-auto px-6 py-16">
            <div class="mx-auto max-w-4xl space-y-16">
                ...
                <section class="flex items-start gap-6" aria-labelledby="mvp-section-heading">
                    <div class="flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-full text-2xl"
                        style="background: linear-gradient(135deg, #1B365D 0%, #2D4A7A 100%);" role="img"
                        aria-label="Icona fase MVP">
                        🚧
                    </div>
                    <div class="flex-1">
                        <h2 id="mvp-section-heading" class="mb-4 text-2xl font-bold md:text-3xl"
                ...
                <section class="flex items-start gap-6" aria-labelledby="reservations-section-heading">
                    <div class="flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-full text-2xl"
                        style="background: linear-gradient(135deg, #2D5016 0%, #3D6B1F 100%);" role="img"
                        aria-label="Icona sistema prenotazioni">
                        📋
                    </div>
                    <div class="flex-1">
                        <h2 id="reservations-section-heading" class="mb-4 text-2xl font-bold md:text-3xl"
                ...
                <section class="flex items-start gap-6" aria-labelledby="roadmap-section-heading">
                    <div class="flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-full text-2xl"
                        style="background: linear-gradient(135deg, #D4A574 0%, #E6B885 100%);" role="img"
                        aria-label="Icona roadmap di sviluppo">
                        🗺️
                    </div>
                    <div class="flex-1">
                        <h2 id="roadmap-section-heading" class="mb-4 text-2xl font-bold md:text-3xl"
    ...
    @slot('belowHeroContent_1')
        ...
        <div class="container mx-auto px-6 py-16">
            <div class="mx-auto max-w-4xl">
                <section class="rounded-2xl px-8 py-16 text-center"
                    style="background: linear-gradient(135deg, #1B365D 0%, #2D4A7A 100%);"
                    aria-labelledby="cta-section-heading">
                    <h2 id="cta-section-heading" class="mb-4 text-3xl font-bold text-white md:text-4xl"
                        style="font-family: 'Playfair Display', serif;">
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (document.referrer.includes('natan') || window.location.hash === '#from-natan') {
                    setTimeout(() => {
                        ...
                        natanWelcome.className =
                            'fixed bottom-6 left-6 max-w-sm p-4 bg-gray-900 border border-emerald-600/30 rounded-lg shadow-lg z-50';
