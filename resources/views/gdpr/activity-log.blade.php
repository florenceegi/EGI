...
@php
    ...
    $breadcrumbItems = [['label' => __('gdpr.activity_log.breadcrumb'), 'url' => null]];
@endphp
                    ...
                    <div class="activity-details">
                        <div class="activity-details-grid">
                            ...
                            @if ($activity->ip_address)
                                <div class="activity-detail-item">
                                    <span
                                        class="activity-detail-label">{{ __('gdpr.activity_log.details.ip_address') }}</span>
                            ...
                            @if ($activity->location)
                                <div class="activity-detail-item">
                                    <span
                                        class="activity-detail-label">{{ __('gdpr.activity_log.details.location') }}</span>
                            ...
                            @if ($activity->risk_level)
                                <div class="activity-detail-item">
                                    <span
                                        class="activity-detail-label">{{ __('gdpr.activity_log.details.risk_level') }}</span>
                                    <span class="activity-detail-value">
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const hasRecentActivities =
                {{ $activities && $activities->where('created_at', '>=', now()->subMinutes(5))->count() > 0 ? 'true' : 'false' }};
