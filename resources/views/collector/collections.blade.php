...
<x-guest-layout :title="$collector->name . ' - ' . __('collector.collections.title_suffix')" :metaDescription="__('collector.collections.meta_description', ['name' => $collector->name])">
        ...
        <script type="application/ld+json">
            {
                ...
                "mainEntity": {
                    ...
                    "owns": {
                        "@type": "Collection",
                        "name": "{{ $collector->name }}'s EGI Collections",
                        "numberOfItems": {{ $collectorCollections->count() }}
                    }
                }
            }
        </script>
    ...
    <x-slot name="heroFullWidth">
        @include('collector.partials.collections-content', [
            'collector' => $collector,
            'collectorCollections' => $collectorCollections,
            'stats' => $stats,
        ])
    </x-slot>
</x-guest-layout>
