<x-pa-layout noHero="true">
    <div class="min-h-screen py-8 bg-gradient-to-br from-gray-50 to-blue-50">
        <div class="max-w-6xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-2 px-4 py-2 bg-green-100 rounded-lg">
                        <span class="text-sm text-green-600 material-icons">check_circle</span>
            ...
            {{-- Chat Container --}}
            <div x-data="natanChat()" x-init="init()" class="max-w-4xl mx-auto">

                {{-- Chat Window --}}
                <div class="mb-4 bg-white shadow-xl rounded-2xl">
                    ...
                    <div class="rounded-t-2xl border-b border-gray-200 bg-gradient-to-r from-[#1B365D] to-[#2D5016] p-6">
                        <div class="flex items-center gap-3">
                            <div
                                ...
                                <span class="text-2xl text-white material-icons">smart_toy</span>
                            </div>
                            <div>
                    ...
                    {{-- Messages Container --}}
                    <div id="chat-messages" class="h-[600px] space-y-4 overflow-y-auto p-6" x-ref="messagesContainer">
                        ...
                        <template x-if="messages.length === 0">
                            <div class="flex flex-col items-center justify-center h-full text-center">
                                <div
                                    ...
                                    <span class="text-4xl text-white material-icons">smart_toy</span>
                                </div>
                        ...
                        <template x-for="(message, index) in messages" :key="index">
                            <div :class="message.role === 'user' ? 'flex justify-end' : 'flex justify-start'">
                                <div :class="message.role === 'user' ?
                                    ...
                                    {{-- Message Content --}}
                                    <div x-html="message.content" class="prose-sm prose max-w-none"></div>
                                    ...
                                    <div :class="message.role === 'user' ? 'text-white/60' : 'text-gray-500'"
                                        class="mt-2 text-xs" x-text="message.timestamp">
                                    </div>
                                </div>
                            </div>
                        </template>
                    ...
                    {{-- Input Area --}}
                    <div class="p-4 border-t border-gray-200 rounded-b-2xl bg-gray-50">
                ...
                <div class="p-4 border border-blue-200 rounded-lg bg-blue-50">
                    <div class="flex items-start gap-3">
                        <span class="text-blue-600 material-icons">info</span>
