...
<x-pa-layout title="{{ __('pa_acts.index.page_title') }}">
    ...
    <div class="mb-8 grid grid-cols-1 gap-6 md:grid-cols-3">
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
            <div class="mb-4">
                <p class="text-sm font-medium text-gray-600">
                    {{ __('pa_acts.index.stats.success_rate') }}
                </p>
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
            <div>
                <p class="text-sm font-medium text-gray-600">
                    {{ __('pa_acts.index.stats.this_month') }}
                </p>
                <p class="mt-2 text-3xl font-bold text-purple-600">
                    {{ $stats['this_month']['uploaded'] ?? 0 }}
                </p>
                <p class="mt-1 text-xs text-gray-500">
                    Atti caricati questo mese
                </p>
            </div>
        </div>
    </div>

    {{-- N.A.T.A.N. AI Analysis Widget (Full Width) --}}
    <div class="mb-8">
        <div
