...
@section('title', __('pa_acts.show.page_title', ['protocol' => $metadata['protocol_number']]))
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            <a href="{{ route('pa.acts.index') }}" 
               class="inline-flex items-center text-[#1B365D] hover:text-[#D4A574] font-medium transition-colors"
            ...
            <div class="flex items-start justify-between">
                <div class="flex-1">
                    <div class="flex items-center space-x-3 mb-2">
                        <h1 class="text-2xl font-serif font-bold text-[#1B365D]">
                ...
                <div>
                    ...
                    <div class="inline-flex items-center px-4 py-2 rounded-lg bg-[#2D5016] bg-opacity-10 text-[#2D5016] font-semibold">
                    ...
                    @else
                    <div class="inline-flex items-center px-4 py-2 rounded-lg bg-[#E67E22] bg-opacity-10 text-[#E67E22] font-semibold">
                        <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
        ...
        {{-- Metadata Section --}}
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-6">
            <h2 class="text-xl font-semibold text-[#1B365D] mb-6 flex items-center">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <p class="text-gray-900 text-lg">{{ $egi->title }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-6">
            ...
            <div class="flex items-start space-x-3 mb-6">
                <div class="flex-shrink-0">
                    <div class="w-12 h-12 bg-[#2D5016] bg-opacity-10 rounded-lg flex items-center justify-center">
                        <svg class="w-7 h-7 text-[#2D5016]" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <div class="flex items-center space-x-2">
                        <p class="text-gray-900 font-mono text-sm break-all">{{ $metadata['anchor_txid'] ?? 'N/A' }}</p>
                        @if($algorand_explorer_url)
                        <a href="{{ $algorand_explorer_url }}" 
                           target="_blank"
                           class="inline-flex items-center px-3 py-1 bg-[#1B365D] hover:bg-[#0F2544] text-white text-xs rounded-lg transition-colors"
                ...
                <div>
                    ...
                    <p class="text-gray-900 font-mono text-sm break-all">{{ $metadata['anchor_root'] ?? 'N/A' }}</p>
                </div>
                ...
                <div>
                    ...
                    <p class="text-gray-900 font-mono text-sm break-all">{{ $metadata['doc_hash'] ?? 'N/A' }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-6">
            <div class="flex items-start space-x-3">
                <div class="flex-shrink-0">
                    <div class="w-12 h-12 bg-[#E67E22] bg-opacity-10 rounded-lg flex items-center justify-center">
                        <svg class="w-7 h-7 text-[#E67E22]" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clip-rule="evenodd"/>
                        </svg>
                    </div>
                </div>
                <div>
                    <h3 class="text-lg font-semibold text-[#E67E22] mb-1">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="text-center">
                    <div class="inline-block p-4 bg-white border-4 border-[#1B365D] rounded-xl">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <div class="flex items-center space-x-2">
                            <input type="text" 
                                   id="public-code"
                                   value="{{ $metadata['public_code'] ?? 'N/A' }}"
                                   readonly
                                   class="flex-1 px-4 py-2 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 font-mono text-sm">
                            <button onclick="copyToClipboard('public-code')"
                                    class="px-4 py-2 bg-[#1B365D] hover:bg-[#0F2544] text-white rounded-lg transition-colors"
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-2">
                            <input type="text" 
                                   ...
                                   readonly
                                   class="flex-1 px-4 py-2 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 text-sm">
                    ...
                    <div class="pt-4">
                        <a href="{{ $verification_url }}" 
                           target="_blank"
                           class="inline-flex items-center px-6 py-3 bg-[#D4A574] hover:bg-[#C39563] text-white font-semibold rounded-lg transition-colors w-full justify-center">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/>
                            </svg>
