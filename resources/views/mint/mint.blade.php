                            ...
                            <div class="space-y-3">
                                ...
                                <form id="regenerate-cert-form"
                                    ...
                                    <button type="button" id="regenerate-cert-btn"
                                        ...
                                        <span id="regenerate-btn-text">{{ __('mint.post_mint.regenerate_certificate') }}</span>
                                    </button>
                                </form>
                    ...
                    try {
                        ...
                        if (data.success) {
                            ...
                            if (thumbnailContainer) {
                                ...
                                thumbnailContainer.classList.add('opacity-50', 'scale-95', 'transition-all', 'duration-300');
                                ...
                                flash.className = 'absolute inset-0 bg-green-500 opacity-30 animate-pulse pointer-events-none z-50';
