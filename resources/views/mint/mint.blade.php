                                ...
                                @if ($certificate->hasPdf())
                                    ...
                                    <details class="group mt-3" id="coaPdfThumbSection-{{ $certificate->id }}" open>
                                        ...
                                        <div id="coaPdfPreview-{{ $certificate->id }}"
                                            ...
                                            class="relative mx-auto flex aspect-[3/4] w-[280px] cursor-pointer flex-col items-center justify-center overflow-hidden rounded-xl border-4 border-indigo-200 bg-gradient-to-br from-gray-50 to-gray-100 shadow-lg transition-all hover:border-indigo-400 hover:shadow-2xl">
