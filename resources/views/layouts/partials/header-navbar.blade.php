        ...
        <div class="@if ($user) flex flex-col @else h-16 @endif md:h-20">
            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <nav class="items-center hidden space-x-1 md:flex" role="navigation"
                    ...
                    @if (!$user)
                        ...
                        <button type="button" id="connect-real-wallet-button" data-action="open-real-wallet-modal"
                            class="inline-flex items-center px-3 py-2 ml-2 text-sm font-medium transition-colors border rounded-md border-emerald-500 text-emerald-400 hover:bg-emerald-600/20 hover:text-emerald-300 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
                        ...
                        <a href="{{ route('register') }}" id="register-link-desktop"
                            class="inline-flex items-center px-4 py-2 ml-2 text-sm font-medium text-white transition-colors border rounded-md border-emerald-600 bg-emerald-600 hover:bg-emerald-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2">
                ...
                <button type="button" data-mobile-menu-trigger
                    class="block p-1 transition-colors rounded-full hover:bg-gray-800/50 md:hidden">
                    @if ($user)
                        ...
                        @else
                            <div
                                class="flex items-center justify-center w-8 h-8 text-sm font-bold text-white bg-gray-600 rounded-full">
                ...
                @guest
                    <div class="flex items-center gap-2 md:hidden">
                        ...
                        <a href="{{ route('register') }}" id="register-link-mobile"
                            class="inline-flex items-center px-4 py-2 text-sm font-medium text-white transition-colors border rounded-md border-emerald-600 bg-emerald-600 hover:bg-emerald-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2">
