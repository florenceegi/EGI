...
<div class="min-h-screen bg-gray-800">
    <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 grid grid-cols-1 gap-6 md:grid-cols-3">
            <div
                class="rounded-2xl border border-[#2D7D46]/50 bg-gradient-to-br from-[#2D7D46]/20 to-transparent p-6 text-center">
            ...
            <div
                class="rounded-2xl border border-[#1E3A5F]/50 bg-gradient-to-br from-[#1E3A5F]/20 to-transparent p-6 text-center">
            ...
            <div
                class="rounded-2xl border border-[#C9A227]/50 bg-gradient-to-br from-[#C9A227]/20 to-transparent p-6 text-center">
