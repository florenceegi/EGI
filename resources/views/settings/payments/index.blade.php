    ...
    <div class="container mx-auto max-w-4xl px-4 py-8">
        ...
        @if (!$user->isSeller())
            <div class="mb-6 rounded-lg border border-yellow-500/50 bg-yellow-500/20 p-4">
                <p class="text-white">{{ __('payment.settings_restricted_to_sellers') }}</p>
            </div>
        @else
            <div class="space-y-6">
                            ...
                            <div
                                ...
                                <form id="bank-config-form" class="space-y-4">
                                    ...
                                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                        <div>
                                            <label for="iban"
                                                class="mb-1 block text-sm font-medium text-gray-300">IBAN
                                                *</label>
                                            <input type="text" id="iban" name="iban"
                                                value="{{ $userMethod?->getIban() }}"
