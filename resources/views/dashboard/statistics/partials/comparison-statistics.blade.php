...
<div class="mb-8">
    ...
    <div class="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
        {{-- Conversion Rate --}}
        <div
            class="from-oro-fiorentino rounded-xl border border-gray-700 bg-gradient-to-br to-orange-600 p-6 backdrop-blur-sm">
    ...
    <div class="rounded-xl border border-yellow-700 bg-yellow-900 bg-opacity-30 p-6 backdrop-blur-sm">
        <div class="flex items-start space-x-3">
            <svg class="mt-1 h-6 w-6 flex-shrink-0 text-yellow-400" fill="none" stroke="currentColor"
                viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
