...
<body class="bg-gradient-to-br from-amber-50 to-yellow-50 font-sans antialiased">
        ...
        <div class="container mx-auto px-4">
                    ...
                    <div class="mt-6 flex justify-center">
                        <div class="relative">
                            <img src="{{ $artwork['image_url'] }}" alt="{{ $artwork['name'] }}"
                                class="h-64 w-64 rounded-lg border-4 border-amber-200 object-cover shadow-lg">
                            <div
                                class="absolute -bottom-2 -right-2 rounded-full bg-amber-600 px-2 py-1 text-xs text-white">
            ...
            <div class="mx-auto mb-6 max-w-5xl">
                @if ($certificate['effective_status'] === 'valid')
                    <div class="flex items-center justify-between rounded-lg bg-green-500 p-4 text-white">
                ...
                @elseif($certificate['effective_status'] === 'incomplete')
                    <div class="flex items-center justify-between rounded-lg bg-amber-500 p-4 text-white">
                        <div class="flex items-center">
                            <svg class="mr-3 h-6 w-6" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
            ...
            @if (isset($artwork['traits']) &&
                    isset($artwork['traits']['traits_incomplete']) &&
                    $artwork['traits']['traits_incomplete']
            )
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 text-sm">
                                        ...
                                        Il certificato NON È VALIDO finché non vengono configurati i CoA traits
            ...
            <div class="mx-auto max-w-5xl">
                <div class="overflow-hidden rounded-xl bg-white shadow-2xl">
                    ...
                    <div class="grid gap-8 p-8 md:grid-cols-2">
                        ...
                        {{-- LEFT: Identità Opera --}}
                        <div class="space-y-6">
                            <h2 class="border-b pb-2 text-lg font-bold text-gray-900">
                                Informazioni Opera
                            </h2>
                            ...
                            @if ($artwork['technique'] || $artwork['materials'] || $artwork['support'])
                                <div
                                    class="rounded-lg border border-gray-200 bg-gradient-to-r from-blue-50 to-green-50 p-4">
                                        ...
                                        @if ($artwork['technique'])
                                            <div class="flex items-center space-x-2">
                                                ...
                                                <div>
                                                    ...
                                                    <span
                                                        class="ml-1 text-sm text-gray-900">{{ $artwork['technique'] }}</span>
                                                </div>
                                            </div>
                                        @endif
                                        ...
                                        @if ($artwork['materials'])
                                            <div class="flex items-center space-x-2">
                                                ...
                                                <div>
                                                    ...
                                                    <span
                                                        class="ml-1 text-sm text-gray-900">{{ $artwork['materials'] }}</span>
                                                </div>
                                            </div>
                                        @endif
                                        ...
                                        @if ($artwork['support'])
                                            <div class="flex items-center space-x-2">
                                                ...
                                                <div>
                                                    ...
                                                    <span
                                                        class="ml-1 text-sm text-gray-900">{{ $artwork['support'] }}</span>
                                                </div>
                                            </div>
                                        @endif
                                    </div>
                            ...
                            @if (isset($artwork['traits']['data']) && count($artwork['traits']['data']) > 0)
                                <div class="rounded-lg border bg-gray-50 p-4">
                                    <h3 class="mb-3 flex items-center text-sm font-semibold text-gray-800">
                                    ...
                                    <div class="grid grid-cols-1 gap-2 text-sm">
                                        @foreach ($artwork['traits']['data'] as $trait)
                                            @if (isset($trait['value']) && $trait['value'] && trim($trait['value']) !== '')
                                                <div
                                                    class="flex items-center justify-between border-b border-gray-200 py-1 last:border-0">
                                                    ...
                                                    <span
                                                        class="text-right text-gray-900">{{ $trait['value'] }}</span>
                                                </div>
                                            @endif
                                        @endforeach
                                    </div>
                            ...
                            @if (isset($artwork['traits']['metadata']) && count($artwork['traits']['metadata']) > 0)
                                <div class="rounded-lg border border-blue-200 bg-blue-50 p-4">
                                    <h3 class="mb-3 flex items-center text-sm font-semibold text-blue-800">
                                        <svg class="mr-2 h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
                                    ...
                                    <div class="space-y-3">
                                        @php
                                            $groupedMetadata = collect($artwork['traits']['metadata'])->groupBy(
                                                'category',
                                            );
                                        @endphp
                                        ...
                                        @foreach ($groupedMetadata as $category => $items)
                                            <div>
                                                <h4
                                                    class="mb-2 text-xs font-medium uppercase tracking-wide text-blue-700">
                                                ...
                                                <div class="grid grid-cols-1 gap-1 text-sm">
                                                    @foreach ($items as $item)
                                                        <div class="flex items-start justify-between py-1">
                                                            <span
                                                                class="text-xs font-medium text-blue-700">{{ $item['label'] }}:</span>
                                                            <span class="max-w-xs text-right text-xs text-blue-900">
                                        ...
                                        @foreach ($artwork['traits'] as $trait)
                                            @if (isset($trait['value']) && $trait['value'] && trim($trait['value']) !== '')
                                                <div
                                                    class="flex items-center justify-between border-b border-gray-200 py-1 last:border-0">
                                                    <span
                                                        class="font-medium text-gray-700">{{ $trait['trait_type'] ?? 'Trait' }}:</span>
                                                    <span
                                                        class="text-right text-gray-900">{{ $trait['value'] }}</span>
                                                </div>
                                            @endif
                            ...
                            @if (isset($creator))
                                <div class="col-span-full rounded-lg border border-blue-200 bg-blue-50 p-4">
                                    <div class="flex items-start space-x-3">
                                        <div class="flex-shrink-0">
                                            <svg class="mt-0.5 h-5 w-5 text-blue-600" fill="currentColor"
                                                viewBox="0 0 20 20">
                                                <path fill-rule="evenodd"
                            ...
                            <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                                ...
                                @if ($annexes['provenance'] ?? false)
                                    <div class="rounded-lg border p-4 transition-shadow hover:shadow-md">
                                        <div class="mb-2 flex items-center justify-between">
                                            <span
                                                class="rounded bg-blue-100 px-2 py-1 text-xs font-medium text-blue-800">A</span>
                                            <span
                                        ...
                                        <div class="mb-2 font-mono text-xs text-gray-500">SHA-256:
                                            {{ Str::limit($annexes['provenance']['hash'], 16) }}...</div>
                                ...
                                @if ($annexes['condition'] ?? false)
                                    <div class="rounded-lg border p-4 transition-shadow hover:shadow-md">
                                        <div class="mb-2 flex items-center justify-between">
                                            <span
                                                class="rounded bg-green-100 px-2 py-1 text-xs font-medium text-green-800">B</span>
                                            <span
                                        ...
                                        <div class="mb-2 font-mono text-xs text-gray-500">SHA-256:
                                            {{ Str::limit($annexes['condition']['hash'], 16) }}...</div>
                                ...
                                @if ($annexes['exhibitions'] ?? false)
                                    <div class="rounded-lg border p-4 transition-shadow hover:shadow-md">
                                        <div class="mb-2 flex items-center justify-between">
                                            <span
                                                class="rounded bg-purple-100 px-2 py-1 text-xs font-medium text-purple-800">C</span>
                                            <span
                                        ...
                                        <div class="mb-2 font-mono text-xs text-gray-500">SHA-256:
                                            {{ Str::limit($annexes['exhibitions']['hash'], 16) }}...</div>
                                ...
                                @if ($annexes['photos'] ?? false)
                                    ...
                                    @if ($annexes['photos'] ?? false)
                                        <div class="rounded-lg border p-4 transition-shadow hover:shadow-md">
                                            <div class="mb-2 flex items-center justify-between">
                                                <span
                                                    class="rounded bg-orange-100 px-2 py-1 text-xs font-medium text-orange-800">D</span>
                                                <span
                                            ...
                                            <div class="mb-2 font-mono text-xs text-gray-500">SHA-256:
                                                {{ Str::limit($annexes['photos']['hash'], 16) }}...</div>
                                    ...
                                    @if ($annexes['authorization'] ?? false)
                                        <div id="annex-e"
                                            class="rounded-lg border-2 border-amber-200 bg-amber-50 p-4 transition-shadow hover:shadow-md">
                                            <div class="mb-2 flex items-center justify-between">
                                                <span
                                                    class="rounded bg-amber-100 px-2 py-1 text-xs font-medium text-amber-800">E</span>
                                                <span
                                                    class="text-xs text-gray-500">v{{ $annexes['authorization']['version'] }}</span>
                                            </div>
                                            <h3 class="mb-1 flex items-center font-medium text-gray-900">
                                                <svg class="mr-2 h-4 w-4 text-amber-600" fill="currentColor"
                                                    viewBox="0 0 20 20">
                                                    <path fill-rule="evenodd"
                                            ...
                                            <div class="mb-2 font-mono text-xs text-gray-500">SHA-256:
                                                {{ Str::limit($annexes['authorization']['hash'], 16) }}...</div>
                                            <div class="flex space-x-2">
                                                <a href="{{ $annexes['authorization']['download_url'] }}"
                                                    class="text-xs text-blue-600 hover:underline">scarica documenti
                                                    →</a>
                                                @if ($annexes['authorization']['data']['legal_verification_url'] ?? false)
                                                    <a href="{{ $annexes['authorization']['data']['legal_verification_url'] }}"
                                                        class="text-xs text-green-600 hover:underline">verifica legale
                                                        →</a>
                                                @endif
                                            </div>
                                        </div>
                    ...
                    <div class="border-t border-gray-200 p-8">
                        <div class="flex flex-wrap justify-center gap-4">
                            ...
                            <button onclick="downloadPDF()" aria-label="Scarica PDF del certificato"
                                class="flex items-center rounded-lg bg-red-500 px-6 py-3 font-medium text-white transition-colors hover:bg-red-600">
                            ...
                            <button onclick="downloadJSON()" aria-label="Scarica snapshot JSON del certificato"
                                class="flex items-center rounded-lg bg-green-500 px-6 py-3 font-medium text-white transition-colors hover:bg-green-600">
                                <svg class="mr-2 h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                        d="M3 17a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm3.293-7.707a1 1 0 011.414 0L9 10.586V3a1 1 0 112 0v7.586l1.293-1.293a1 1 0 111.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z"
                                        clip-rule="evenodd" />
                            ...
                            <button onclick="window.print()" aria-label="Stampa certificato"
                                class="flex items-center rounded-lg bg-gray-500 px-6 py-3 font-medium text-white transition-colors hover:bg-gray-600">
                                <svg class="mr-2 h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                            ...
                            <button onclick="showAPIVerify()" aria-label="Mostra endpoint API per verifica"
                                class="flex items-center rounded-lg bg-blue-500 px-6 py-3 font-medium text-white transition-colors hover:bg-blue-600">
                                <svg class="mr-2 h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                            ...
                            <button onclick="shareLink()" aria-label="Condividi link del certificato"
                                class="flex items-center rounded-lg bg-amber-500 px-6 py-3 font-medium text-white transition-colors hover:bg-amber-600">
                                <svg class="mr-2 h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
                                    <path
            ...
            {{-- API Verify Modal --}}
            <div id="apiModal" class="fixed inset-0 z-50 hidden bg-black bg-opacity-50" style="display: none;">
                    ...
                    <div class="w-full max-w-2xl rounded-lg bg-white p-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <code
                                    class="block rounded bg-gray-100 p-2 text-sm">{{ url('/api/coa/verify/' . $certificate['serial']) }}</code>
                            </div>
                            <div>
                                <label class="text-sm font-medium text-gray-600">Esempio cURL</label>
                                <pre class="overflow-x-auto rounded bg-gray-100 p-3 text-xs"><code>curl -X GET "{{ url('/api/coa/verify/' . $certificate['serial']) }}" \
    ...
    <script>
        ...
        // Dossier Modal Functions
        function openDossierModal() {
            const modal = document.getElementById('dossier-modal');
            modal.classList.remove('hidden');

            // Set title
            document.getElementById('egi-title').textContent = '{{ $artwork['name'] ?? 'Artwork' }}';

            // Load dossier content
            loadDossierContent({{ $artwork['egi_id'] ?? 0 }});
        }
        ...
        function loadDossierContent(egiId) {
            console.log('Loading dossier for EGI ID:', egiId);
            const content = document.getElementById('dossier-content');

            // Show loading state
            content.innerHTML =
                '<div class="flex items-center justify-center py-8"><div class="text-white">{{ __('egi.dossier.loading') }}</div></div>';

            // Make API call to get dossier data
            const url = `/egis/${egiId}/dossier`;
            ...
            fetch(url)
                ...
                .then(data => {
                    ...
                    if (data.status === 'success') {
                        // Show gallery template with data
                        showGalleryContent(data.data);
                    } else if (data.status === 'no_utility') {
                        // Show no utility template
                        const template = document.getElementById('dossier-no-utility-template');
                        content.innerHTML = template.innerHTML;
                    } else if (data.status === 'no_images') {
                        // Show no images template
                        const template = document.getElementById('dossier-no-images-template');
                        content.innerHTML = template.innerHTML;
                    } else {
                        // Show error state
                        content.innerHTML =
                            '<div class="py-8 text-center text-red-400">{{ __('egi.dossier.error_loading') }}</div>';
                    }
                })
                .catch(error => {
        ...
        function showGalleryContent(data) {
            const content = document.getElementById('dossier-content');
            const template = document.getElementById('dossier-gallery-template');
            content.innerHTML = template.innerHTML;

            // Populate artwork info
            content.querySelector('[data-field="author"]').textContent = data.egi.author || '-';
            content.querySelector('[data-field="year"]').textContent = data.egi.year || '-';
            content.querySelector('[data-field="internal_id"]').textContent = data.egi.internal_id || '-';
            content.querySelector('[data-field="images_count"]').textContent = data.utility.images_count || '0';
            ...
            data.images.forEach((image, index) => {
                ...
                imageElement.className =
                    'group relative overflow-hidden rounded-lg bg-gray-800 cursor-pointer hover:bg-gray-700 transition-colors';
                imageElement.onclick = () => openImageViewer(data.images, index);
        ...
        function openImageViewer(images, startIndex = 0) {
            ...
            description.textContent =
                `{{ __('egi.dossier.image_number') }} ${currentImageIndex + 1} {{ __('egi.dossier.of') }} ${currentImages.length}`;
        ...
        function prevImage() {
            if (currentImageIndex > 0) {
                currentImageIndex--;
                openImageViewer(currentImages, currentImageIndex);
            }
        }
    ...
    {{-- Include Dossier Modal --}}
    @include('egis.dossier.modal')
