        ...
        <div class="mt-8 rounded-xl bg-[#1B365D]/5 p-6">
            ...
            <ul class="space-y-2 text-sm text-gray-700">
                <li class="flex items-start">
                    ...
                    <span><strong>Collezione:</strong> Seleziona la collezione appropriata tra quelle gestite dal tuo ente</span>
                </li>
                <li class="flex items-start">
                    <span class="mr-2 text-[#D4A574]">•</span>
                ...
                <li class="flex items-start">
                    <span class="mr-2 text-[#D4A574]">•</span>
                    <span><strong>Descrizione:</strong> Includi informazioni sulla storia, caratteristiche artistiche e stato di conservazione</span>
                </li>
                <li class="flex items-start">
                    <span class="mr-2 text-[#D4A574]">•</span>
                    <span><strong>Immagine:</strong> Carica un'immagine di alta qualità che rappresenti fedelmente il bene culturale</span>
                </li>
                <li class="flex items-start">
                    <span class="mr-2 text-[#D4A574]">•</span>
                    <span><strong>Certificazione:</strong> Dopo il caricamento, potrai richiedere l'emissione del Certificato di Autenticità (CoA)</span>
                </li>
            </ul>
        </div>
    </div>
