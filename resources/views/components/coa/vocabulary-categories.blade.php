...
<div class="vocabulary-categories-container" data-component="vocabulary-categories">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            @foreach($categories as $category)
                <div class="category-card p-4 border border-gray-200 rounded-lg hover:border-blue-300 hover:shadow-md transition-all cursor-pointer"
                     ...
                     onclick="loadCategoryTerms('{{ $category->slug }}')">
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-xs text-gray-500">
                                {{ $category->terms_count ?? 0 }} termini disponibili
                            </p>
                        </div>
                        <div class="flex-shrink-0">
    ...
    @else
        <div class="text-center py-12">
            ...
            <h3 class="mt-2 text-sm font-medium text-gray-900">Nessuna categoria disponibile</h3>
            <p class="mt-1 text-sm text-gray-500">Non sono state trovate categorie di vocabolario.</p>
        </div>
    @endif
</div>
