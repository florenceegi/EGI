    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-3">
            <div class="flex items-center">
                ...
                <h4 class="text-sm font-medium text-gray-900">{{ __('coa_vocabulary.category_technique') }}</h4>
            </div>
        ...
        <div class="space-y-3">
            <div class="flex items-center">
                ...
                <h4 class="text-sm font-medium text-gray-900">{{ __('coa_vocabulary.category_materials') }}</h4>
            </div>
        ...
        <div class="space-y-3">
            <div class="flex items-center">
                ...
                <h4 class="text-sm font-medium text-gray-900">{{ __('coa_vocabulary.category_support') }}</h4>
            </div>
                ...
                try {
                    ...
                    slugs.forEach(slug => {
                        currentSelections[category].push({
                            slug: slug,
                            name: `{{ __('coa_vocabulary.') }}${slug}`, // Will be replaced by actual translation
                            isCustom: false
                        });
                    });
                } catch (e) {
