    ...
    <div data-dropdown-content
        ...
        <div
            ...
            <div class="grid grid-cols-1 gap-4">
                ...
                <div
                    class="mega-card rounded-2xl border border-emerald-200/30 bg-gradient-to-br from-emerald-50 to-teal-50 p-4 dark:border-emerald-800/30 dark:from-emerald-900/20 dark:to-teal-900/20">
                    <div class="mb-3 flex items-center space-x-3">
                        <div
                            class="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-r from-emerald-500 to-teal-500">
