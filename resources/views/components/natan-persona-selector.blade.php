...
<div class="natan-persona-selector mb-2 rounded-xl border border-gray-200 bg-white p-2 shadow-sm sm:mb-4 sm:p-4">
    ...
    <div id="personaSelectorContent" class="hidden sm:block">
        ...
        <div id="personaInfoPanel" class="mb-2 hidden rounded-lg bg-blue-50 p-2 text-[10px] text-blue-800 sm:mb-3 sm:p-3 sm:text-xs">
            <p class="mb-1"><strong>Modalità Auto:</strong> N.A.T.A.N. sceglie automaticamente l'esperto più adatto.</p>
