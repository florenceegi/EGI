        ...
        <div class="scrollbar-hide flex snap-x snap-mandatory gap-3 overflow-x-auto sm:gap-4">
            <div class="flex gap-3 px-2 sm:gap-4">
                ...
                <a href="{{ route('epp-projects.index') }}"
                    ...
                    <span class="text-green-400">Progetti EPP</span>
                </a>
                ...
                {{-- Bottone White Paper Finanziario ? --}}
                <a href="{{ route('info.white-paper-finanziario') }}"
                    class="flex flex-shrink-0 snap-start items-center rounded-lg border border-gray-700 bg-gray-800 px-4 py-2 text-xs font-medium text-white transition-all duration-200 hover:scale-105 hover:border-gray-600 hover:bg-gray-700 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-gray-900">
                    <svg class="mr-2 h-4 w-4 text-orange-400" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z">
                        </path>
                    </svg>
                    <span class="text-orange-400">White Paper</span>
                    <span class="ml-1 text-gray-300">?</span>
                </a>
