        ...
        window.stripeWizard = {
            ...
            go: function(step) {
                [1, 2, 3, 4].forEach(function(s) {
                    ...
                    if (el) {
                        s === step ? el.classList.remove('hidden') : el.classList.add('hidden');
                    }
                    if (dot) {
            ...
            openPopup: async function() {
                ...
                var ctaLabel =
                    '{{ __('payment.wizard.step3_cta', ['psp_name' => config('egi.payment.psp_name')]) }}';
                ...
                try {
                    ...
                    var self = this;
                    window.stripeOnboardingComplete = function() {
                        self._onPopupClose(true);
                    };
            ...
            checkStatus: async function() {
                ...
                try {
                    ...
                    if (data.connected && data.status === 'complete') {
                        ...
                        setTimeout(function() {
                            if (window.paymentModal && typeof window.paymentModal.loadContent ===
                                'function') {
