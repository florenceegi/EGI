{{-- Modal overlay --}}
<div id="walletWelcomeModal" class="wallet-modal-overlay hidden" role="dialog" aria-modal="true" aria-labelledby="modalTitle">
    {{-- Modal container --}}
            ...
            <div class="wallet-sections">
                ...
                <div class="wallet-section">
                    ...
                    <div class="wallet-section-content" id="section-payments">
                        ...
                        <div class="wallet-highlight-box mt-6">
                            ...
                            <h5 class="font-semibold text-sm mb-2">{{ __('wallet_welcome.payments_iban_security_title') }}</h5>
                ...
                <div class="wallet-section">
                    ...
                    <div class="wallet-section-content" id="section-compliance">
                        ...
                        <h4 class="wallet-subsection-title mt-6">{{ __('wallet_welcome.compliance_platform_title') }}</h4>
                        <ul class="wallet-list">
                ...
                <div class="wallet-section">
                    ...
                    <div class="wallet-section-content" id="section-help">
                        <div class="wallet-help-grid">
                            <a href="{{ route('info.white-paper-finanziario') }}" class="wallet-help-card" target="_blank">
            ...
            <div id="noIbanWarning" class="wallet-warning-box hidden">
                ...
                <div class="wallet-warning-content">
                    ...
                    <p class="wallet-warning-text">
                        Procedendo <strong>senza IBAN</strong>, non potrai ricevere pagamenti in <strong>€ (euro)</strong> per le tue opere.<br><br>
                        Inoltre, fino a quando <strong>non riscatterai il tuo wallet</strong> (scaricando la frase segreta di 25 parole), 
                        i tuoi <strong>Certificati EGI non saranno vendibili</strong> ad altri utenti.<br><br>
                        Potrai comunque aggiungere l'IBAN in qualsiasi momento dalle <strong>Impostazioni → Profilo → Pagamenti</strong>.
                    </p>
    ...
    ibanForm.addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch('/api/wallet/welcome/add-iban', {
                ...
                body: JSON.stringify({ iban, dont_show_again: dontShowAgain })
            });
