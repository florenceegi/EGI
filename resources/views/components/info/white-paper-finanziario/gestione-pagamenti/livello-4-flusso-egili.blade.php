...
<details class="collapsible-section">
    <summary>
        <span class="text-xl material-icons">stars</span> 
    ...
    <div class="collapsible-content">
        ...
        <ul class="mb-4 space-y-1 text-gray-700 list-disc list-inside">
            ...
            <li><strong>Account-bound:</strong> Legato all'account utente, non a un <a href="#glossary-wallet" class="glossary-link">wallet</a> crypto.</li>
        ...
        <div class="space-y-3 text-gray-700">
            <ol class="space-y-2 list-decimal list-inside">
                <li><strong>Verifica saldo:</strong> Il sistema controlla che il Buyer abbia EGILI sufficienti (es. EGI a €25 richiede 2.500 EGILI).</li>
                <li><strong>Bruciatura (Burn):</strong> Gli EGILI del Buyer vengono <strong>rimossi definitivamente</strong> dalla circolazione (meccanismo deflazionario).</li>
                <li><strong>Regalo al Creator:</strong> La piattaforma <strong>regala EGILI Gift</strong> al Creator in quantità equivalente a quelli bruciati.</li>
                <li><strong>Mint EGI:</strong> L'<a href="#glossary-egi" class="glossary-link">EGI</a> viene mintato e trasferito al Buyer normalmente.</li>
            ...
            <table class="min-w-full text-sm border border-gray-300">
                <thead class="bg-gray-100">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-left border">Acquisizione</th>
                        <th class="px-4 py-2 text-left border">Scadenza</th>
                        <th class="px-4 py-2 text-left border">Priorità Consumo</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="px-4 py-2 font-semibold border">Gift</td>
                        <td class="px-4 py-2 border">Donati dalla piattaforma</td>
                        <td class="px-4 py-2 border">⏰ N giorni</td>
                        <td class="px-4 py-2 border">🔴 Prima (scadenza più vicina)</td>
                    </tr>
                    <tr>
                        <td class="px-4 py-2 font-semibold border">Lifetime</td>
                        <td class="px-4 py-2 border">Acquistati dall'utente</td>
                        <td class="px-4 py-2 border">♾️ Mai</td>
                        <td class="px-4 py-2 border">🟢 Dopo</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        {{-- Conformità MiCA --}}
        <div class="p-4 mt-6 border-l-4 border-green-600 rounded-lg bg-green-50">
