...
<div class="p-6 overflow-hidden bg-white max-h-96 rounded-xl bg-opacity-10 backdrop-blur-md"
    ...
    @if ($totalLikes > 0)
        <div class="pr-2 space-y-3 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-gray-800 max-h-48"
