...
<div class="max-h-96 rounded-xl bg-white bg-opacity-10 p-6 backdrop-blur-md">
    {{-- Header --}}
    ...
    @if ($totalLikes > 0)
        <div class="max-h-48 space-y-3 overflow-y-auto rounded-lg border border-gray-700 p-2"
