...
<div id="art-advisor-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/60 backdrop-blur-sm"
    ...
    {{-- Modal Container --}}
    <div
        class="relative flex h-[90vh] w-[95vw] max-w-4xl flex-col overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 shadow-2xl">

        {{-- Header --}}
        <div
            class="flex items-center justify-between border-b border-gray-700/50 bg-gradient-to-r from-blue-900/30 to-purple-900/30 px-6 py-4">
            <div>
                ...
                <div class="space-y-2 px-6 pb-4 text-sm">
                    @if (isset($context['egi_number']) || isset($context['egi_id']))
                        <div class="flex items-center gap-2">
                            ...
                            <span
                                class="font-mono text-blue-400">#{{ $context['egi_number'] ?? $context['egi_id'] }}</span>
                        </div>
                    @endif
                    ...
                    @if (isset($context['price_eur']))
                        <div class="flex items-center gap-2">
                            ...
                            <span
                                class="font-semibold text-green-400">€{{ number_format($context['price_eur'], 2) }}</span>
                        </div>
                    @endif
        ...
        {{-- Chat Messages Area --}}
        <div id="art-advisor-messages" class="flex-1 space-y-4 overflow-y-auto p-6" style="scroll-behavior: smooth;">
        ...
        <div class="border-t border-gray-700/50 bg-gray-800/50 p-4">
            <form id="art-advisor-form" class="flex gap-3">
                <input type="text" id="art-advisor-input"
                    ...
                    placeholder="{{ __('art_advisor.chat.placeholder') }}" autocomplete="off" maxlength="1000">

                <button type="submit" id="art-advisor-send-btn"
...
<button id="art-advisor-trigger"
    ...
    title="{{ __('art_advisor.title') }}" aria-label="{{ __('art_advisor.title') }}">
    🎨
</button>
