    ...
    <div class="gdpr-cookie-banner__info">
        ...
        <p id="cookie-banner-description" class="gdpr-cookie-banner__description">
            ...
            <a href="{{ route('gdpr.privacy-policy') }}"
               class="gdpr-cookie-banner__link"
               target="_blank"
            ...
            <div class="gdpr-cookie-banner__actions">
                ...
                <button
                    id="cookie-customize"
                    type="button"
                    class="gdpr-cookie-banner__button gdpr-cookie-banner__button--tertiary"
                    aria-expanded="false"
        ...
        <button
            ...
            type="button"
            class="gdpr-cookie-banner__close"
            aria-label="{{ __('gdpr.cookie.banner.close') }}"
            style="display: none;"
        >
...
.gdpr-cookie-banner__category-name {
    ...
    margin: 0 0 4px 0;
    font-size: 14px;
    color: #1f2937; /* Testo scuro per essere visibile su sfondo bianco delle categorie */
}
    ...
    const CookieConsentBanner = {
        ...
        bindEvents() {
            ...
            if (this.elements.closePreferences) {
                this.elements.closePreferences.addEventListener('click', () => this.togglePreferences());
            }
        ...
        renderCategories() {
            ...
            this.elements.categoriesContainer.innerHTML = categories.map(([key, category]) => {
                ...
                const description = translation ? translation.description : (category.description || '');
        ...
        showBanner() {
            if (this.elements.banner) {
                ...
                if (this.elements.close) {
                    this.elements.close.style.display = this.consentState.hasConsented ? 'block' : 'none';
                }
            }
        },
        ...
        togglePreferences() {
            ...
            if (!isVisible) {
                console.log('🔄 togglePreferences: Re-rendering categories because opening preferences');
                this.renderCategories();
            }
        ...
        async savePreferences() {
            ...
            const checkboxes = this.elements.categoriesContainer.querySelectorAll('input[type="checkbox"]');
