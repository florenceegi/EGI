...
<div class="mt-10 overflow-hidden bg-white rounded-lg shadow-md"
    ...
    {{-- Header --}}
    <div class="flex items-center justify-between p-4 cursor-pointer bg-gradient-to-r from-green-600 to-emerald-600"
        ...
        <div class="flex items-center text-white">
            <span class="mr-2 text-sm">{{ $certificates->count() }} {{ trans_choice('certificate.mint_history.entries', $certificates->count()) }}</span>
                        ...
                        @foreach($certificates as $certificate)
                            <li class="mint-timeline-item">
                                <div class="mint-timeline-connector">
                                    <div class="bg-green-500 mint-timeline-icon">
                                ...
                                <div class="mint-timeline-content">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center">
                                            <div class="flex items-center justify-center w-10 h-10 mr-3 rounded-md bg-green-50">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xs text-gray-500">
                                                    ...
                                                    <span class="inline-flex ml-1 px-1.5 py-0.5 text-xs font-medium rounded-full bg-green-100 text-green-800">
                                    ...
                                    {{-- Blockchain Info --}}
                                    @if($certificate->egiBlockchain)
                                        <div class="px-3 py-2 mt-3 border border-green-100 rounded-md bg-green-50">
                                            <div class="flex items-center justify-between text-xs">
                                                <div class="flex items-center text-gray-600">
                                                    ...
                                                    <span class="font-medium">{{ __('certificate.ownership_type') }}:</span>
                                                    <span class="ml-1">
