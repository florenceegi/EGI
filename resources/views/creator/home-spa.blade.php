...
<button onclick="window.paymentModal.open()" class="group relative overflow-hidden rounded-xl bg-gradient-to-r from-amber-600 via-yellow-500 via-amber-500 to-orange-600 p-[2px] shadow-xl shadow-amber-500/40 transition-all duration-500 hover:scale-[1.02] hover:shadow-[0_0_40px_rgba(251,191,36,0.6)]">
    ...
    <div class="relative rounded-xl bg-gradient-to-br from-gray-900 to-black px-4 py-2.5">
        <div class="flex items-center gap-3">
            ...
            <div class="relative h-8 w-12 rounded-md bg-gradient-to-br from-amber-400 via-yellow-500 to-amber-600 shadow-lg shadow-amber-500/40 transition-all duration-500 group-hover:rotate-6 group-hover:scale-110 overflow-hidden">
                ...
                <div class="absolute bottom-1 left-1 text-[6px] font-bold text-white/90 tracking-wide drop-shadow">
                    •••• 4242
                </div>
