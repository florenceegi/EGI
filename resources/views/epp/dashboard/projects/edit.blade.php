                ...
                <div class="p-6">
                    <form action="{{ route('epp.dashboard.projects.update', $project) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <div id="dropZoneAvatar" 
                                    ...
                                    <div id="uploadPromptAvatar" class="{{ $project->hasMedia('project_avatar') ? 'hidden' : '' }}">
                                    ...
                                    <div id="avatarPreview" class="{{ $project->hasMedia('project_avatar') ? '' : 'hidden' }}">
                                        <img id="previewAvatar" 
                                             src="{{ $project->getFirstMediaUrl('project_avatar') }}" 
                                             alt="{{ $project->name }}" 
                        ...
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            const changeBtnAvatar = document.getElementById('changeAvatar');
                            ...
                            dropZoneAvatar.addEventListener('click', function(e) {
                                if (e.target !== removeBtnAvatar && !removeBtnAvatar.contains(e.target) && 
                                    e.target !== changeBtnAvatar && !changeBtnAvatar.contains(e.target)) {
                                    fileInputAvatar.click();
                                }
                            });

                            changeBtnAvatar?.addEventListener('click', function(e) {
                                e.stopPropagation();
                                fileInputAvatar.click();
                            });
