...
<x-app-layout>
    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <!-- Welcome Section -->
            <div
                class="mb-8 overflow-hidden rounded-lg bg-gradient-to-r from-green-700 to-green-600 p-6 text-white shadow-lg">
                ...
                <div class="overflow-hidden rounded-lg bg-white shadow">
                    ...
                    <div class="p-6">
                        @forelse($projects->take(3) as $project)
                            <div
                                class="mb-4 rounded-lg border border-gray-200 p-4 transition-all hover:border-green-300 hover:shadow-md">
                                <div class="mb-2 flex items-start justify-between">
                                    ...
                                    <span
                                        class="{{ $project->status === 'in_progress' ? 'bg-green-100 text-green-800' : '' }} {{ $project->status === 'planned' ? 'bg-blue-100 text-blue-800' : '' }} {{ $project->status === 'completed' ? 'bg-gray-100 text-gray-800' : '' }} rounded-full px-3 py-1 text-xs font-medium">
                                ...
                                @if ($project->target_value && $project->target_value > 0)
                                    <div class="mt-3">
                                        <div class="mb-1 flex justify-between text-xs">
                                            ...
                                            <span
                                                class="font-medium text-green-700">{{ round($project->completion_percentage) }}%</span>
                                        </div>
                                ...
                                @else
                                    <div class="mt-3">
                                        <p class="text-xs text-gray-500">
                                            <span
                                                class="font-medium text-blue-700">{{ number_format($project->current_value ?? 0, 0, ',', '.') }}</span>
                                            <span
                                                class="italic">{{ __('epp_dashboard.projects.no_target_set') }}</span>
                                        </p>
                                    </div>
                                @endif
                                <div class="mt-3 flex items-center justify-between text-sm">
                                    <span class="text-gray-600">
                                        ...
                                        {{ __('epp_dashboard.home.collections') }}
                                    </span>
                ...
                <div class="overflow-hidden rounded-lg bg-white shadow">
                    ...
                    <div class="p-6">
                        @forelse($collections as $collection)
                            <div
                                class="mb-4 flex items-center rounded-lg border border-gray-200 p-4 transition-all hover:border-green-300 hover:shadow-md">
                                @php
                                ...
                                @else
                                    <div
                                        class="mr-4 flex h-16 w-16 items-center justify-center rounded-lg bg-gradient-to-br from-green-100 to-green-200 text-2xl">
                                        🌿
                                    </div>
                                @endif
                                <div class="flex-1">
            ...
            <div class="mt-8 overflow-hidden rounded-lg bg-white shadow">
                ...
                <div class="grid grid-cols-1 gap-4 p-6 md:grid-cols-3">
                    <a href="{{ route('epp.dashboard.projects') }}"
                        ...
                        <div>
                            <div class="font-semibold text-gray-900">{{ __('epp_dashboard.home.manage_projects') }}
                            </div>
                            <div class="text-sm text-gray-600">{{ __('epp_dashboard.home.manage_projects_desc') }}
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="{{ route('epp.dashboard.collections') }}"
                        ...
                        <div
                            class="mr-4 flex h-12 w-12 items-center justify-center rounded-full bg-purple-100 text-2xl">
                            📚
                        </div>
                        <div>
                            <div class="font-semibold text-gray-900">{{ __('epp_dashboard.home.manage_collections') }}
                            </div>
                            <div class="text-sm text-gray-600">{{ __('epp_dashboard.home.manage_collections_desc') }}
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="{{ route('epp-projects.index') }}"
                        ...
                        <div>
                            <div class="font-semibold text-gray-900">{{ __('epp_dashboard.home.view_public_page') }}
                            </div>
                            <div class="text-sm text-gray-600">{{ __('epp_dashboard.home.view_public_page_desc') }}
                            </div>
                        </div>
                    </a>
                </div>
