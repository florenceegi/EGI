...
console.log("FlorenceEGI RESET: Loading Shader Quad...");
...
class FlorenceReset {
    constructor(canvasContainerId) {
        ...
        // --- SHADER QUAD ONLY ---
        // No IcosahedronGeometry. No MeshStandardMaterial.
        // Just a plane with the GLSL code.
        ...
        const fragmentShader = `
            ...
            void main() {
                ...
                // Stars in background (Simple procedural stars in shader)
...
document.addEventListener('DOMContentLoaded', () => {
    new FlorenceReset('canvas-container');
});
