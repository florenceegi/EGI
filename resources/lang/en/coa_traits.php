...
return [
    /*
    |--------------------------------------------------------------------------
    | CoA Traits Management - English Translations
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    // Traits Management
    'management_title' => 'CoA Traits Management',
    'management_description' => 'Configure the technical characteristics of the artwork for the Certificate of Authenticity',
    ...
    'no_categories_found' => 'No vocabulary categories were found.',

    // Vocabulary Components - Terms
    'categories' => 'Categories',
    'terms_found' => 'terms found',
    'no_terms_available' => 'No terms available',
    'no_terms_found_category' => 'No terms found for category',
    ...
    'pdf_certificate_id' => 'Certificate ID',
    'category_platform_metadata' => 'Platform Metadata',
    'pdf_verification_title' => 'Certificate Verification',
    'pdf_scan_prompt' => 'Scan the QR code to verify the authenticity of the certificate online',
    'pdf_additional_info_title' => 'Additional Information',
    'pdf_stamp_area' => 'Stamp Area',
    'pdf_stamp_caption' => 'Author Stamp',
    'pdf_author_signature' => 'Author Signature',
    'pdf_core_certificate' => 'Core Certificate',
