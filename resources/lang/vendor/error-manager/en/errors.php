...
return [
    ...
    */
    ...
    'dev' => [
        ...
        // COA System - Services Layer (Dev Messages)
        'coa_serial_generation_error' => 'Failed to generate unique CoA serial number. Error: :error',
        'coa_serial_validation_error' => 'CoA serial number validation failed. Serial: :serial, Error: :error',
        'coa_serial_uniqueness_check_error' => 'Critical error during serial uniqueness verification. Error: :error',
        'coa_serial_parse_error' => 'Failed to parse CoA serial number format. Serial: :serial, Error: :error',
        'coa_serial_statistics_error' => 'Error retrieving CoA serial statistics. Error: :error',
        'coa_serial_years_query_error' => 'Failed to query available years for CoA serials. Error: :error',
        'coa_hash_generation_error' => 'Critical failure in CoA hash generation. Data: :data, Error: :error',
        'coa_traits_hash_error' => 'Failed to generate hash for CoA traits. EGI ID: :egi_id, Error: :error',
        'coa_hash_verification_error' => 'CoA hash verification failed. Hash: :hash, Error: :error',
        'coa_multi_hash_error' => 'Multi-hash generation failed for CoA. Error: :error',
        'coa_multi_hash_verification_error' => 'Multi-hash verification failed for CoA. Error: :error',
        'coa_file_hash_error' => 'File hash generation failed for CoA annex. File: :filename, Error: :error',
        'coa_hash_format_validation_error' => 'Invalid hash format provided. Format: :format, Error: :error',
        'coa_digital_signature_error' => 'Digital signature creation failed for CoA. CoA ID: :coa_id, Error: :error',
        'coa_physical_signature_error' => 'Physical signature process failed for CoA. CoA ID: :coa_id, Error: :error',
        'coa_digital_signature_verify_error' => 'Digital signature verification failed. Signature ID: :signature_id, Error: :error',
        'coa_get_signatures_error' => 'Failed to retrieve CoA signatures. CoA ID: :coa_id, Error: :error',
        'coa_traits_version_create_error' => 'Failed to create traits version snapshot. EGI ID: :egi_id, Error: :error',
        'coa_snapshot_create_error' => 'Critical error creating CoA snapshot. CoA ID: :coa_id, Error: :error',
        'coa_snapshot_integrity_check_error' => 'Snapshot integrity verification failed. Snapshot ID: :snapshot_id, Error: :error',
        'coa_issue_certificate_error' => 'Certificate issuance failed. EGI ID: :egi_id, Error: :error',
        'coa_reissue_certificate_error' => 'Certificate re-issuance failed. CoA ID: :coa_id, Error: :error',
        'coa_issue_validation_error' => 'CoA issuance validation failed. Validation errors: :errors',
        'coa_revoke_certificate_error' => 'Certificate revocation failed. CoA ID: :coa_id, Error: :error',
        'coa_revoke_validation_error' => 'CoA revocation validation failed. Validation errors: :errors',
        'coa_revoke_history_error' => 'Failed to retrieve revocation history. CoA ID: :coa_id, Error: :error',
        'coa_batch_revoke_error' => 'Batch revocation operation failed. Affected CoAs: :coa_count, Error: :error',
        'coa_annex_create_error' => 'Annex creation failed. CoA ID: :coa_id, Type: :type, Error: :error',
        'coa_annex_update_error' => 'Annex update failed. Annex ID: :annex_id, Error: :error',
        'coa_get_annexes_error' => 'Failed to retrieve CoA annexes. CoA ID: :coa_id, Error: :error',
        'coa_bundle_create_error' => 'Bundle creation failed. CoA ID: :coa_id, Error: :error',
        'coa_bundle_estimate_error' => 'Bundle size estimation failed. CoA ID: :coa_id, Error: :error',
        'coa_addendum_create_error' => 'Addendum creation failed. CoA ID: :coa_id, Type: :type, Error: :error',
        'coa_policy_create_error' => 'Policy creation failed. Type: :type, Error: :error',
        'coa_get_addendums_error' => 'Failed to retrieve CoA addendums. CoA ID: :coa_id, Error: :error',
        'coa_get_policies_error' => 'Failed to retrieve active policies. Error: :error',
        'coa_addendum_integrity_error' => 'Addendum integrity check failed. Addendum ID: :addendum_id, Error: :error',
        'coa_policy_integrity_error' => 'Policy integrity check failed. Policy ID: :policy_id, Error: :error',
        'verify_data_generation_error' => 'Verification data generation failed. CoA Serial: :serial, Error: :error',
        'verify_page_generation_error' => 'Verification page generation failed. CoA ID: :coa_id, Error: :error',
        'verify_public_annexes_error' => 'Public annexes retrieval failed. CoA ID: :coa_id, Error: :error',
        'verify_qr_generation_error' => 'QR code generation failed for verification. CoA ID: :coa_id, Error: :error',
        ...
        'coa_statistics_error' => 'CoA statistics retrieval failed. Error: :error',
        'verify_certificate_error' => 'Certificate verification failed. Serial: :serial, Error: :error',
        'verify_page_error' => 'Verification page controller error. Serial: :serial, Error: :error',
        'verify_hash_error' => 'Hash verification controller error. Hash: :hash, Error: :error',
        'verify_annexes_error' => 'Annexes verification failed. CoA ID: :coa_id, Error: :error',
        'verify_qr_error' => 'QR verification controller error. QR Data: :qr_data, Error: :error',
        'verify_batch_error' => 'Batch verification controller error. Serials count: :count, Error: :error',
        'verify_stats_error' => 'Verification statistics failed. Error: :error',
        'annex_index_error' => 'Annex listing controller error. CoA ID: :coa_id, Error: :error',
        'annex_show_error' => 'Annex detail controller error. Annex ID: :annex_id, Error: :error',
        'annex_create_error' => 'Annex creation controller error. CoA ID: :coa_id, Type: :type, Error: :error',
        'annex_update_error' => 'Annex update controller error. Annex ID: :annex_id, Error: :error',
        'annex_history_error' => 'Annex history controller error. Annex ID: :annex_id, Error: :error',
        'annex_integrity_error' => 'Annex integrity controller error. Annex ID: :annex_id, Error: :error',
        'annex_types_error' => 'Annex types retrieval failed. Error: :error',
        'addendum_list_error' => 'Addendum listing controller error. Filters: :filters, Error: :error',
        'addendum_not_found' => 'Addendum not found. Addendum ID: :addendum_id',
        'addendum_detail_error' => 'Addendum detail controller error. Addendum ID: :addendum_id, Error: :error',
        'addendum_creation_error' => 'Addendum creation controller error. CoA ID: :coa_id, Type: :type, Error: :error',
        'addendum_not_editable' => 'Addendum is not editable. Status: :status, Addendum ID: :addendum_id',
        'addendum_update_error' => 'Addendum update controller error. Addendum ID: :addendum_id, Error: :error',
        'addendum_not_revisable' => 'Addendum is not revisable. Status: :status, Addendum ID: :addendum_id',
        'addendum_revision_error' => 'Addendum revision controller error. Original ID: :original_id, Error: :error',
        'addendum_not_publishable' => 'Addendum is not publishable. Status: :status, Addendum ID: :addendum_id',
        'addendum_publish_error' => 'Addendum publish controller error. Addendum ID: :addendum_id, Error: :error',
    ...
    'user' => [
        ...
        // COA System - User Messages (English)
        'coa_serial_generation_error' => 'Unable to generate certificate serial number. Please try again.',
        'coa_serial_validation_error' => 'The provided serial number format is invalid.',
        'coa_serial_uniqueness_check_error' => 'Unable to verify serial number uniqueness. Please try again.',
        'coa_serial_parse_error' => 'Invalid serial number format provided.',
        'coa_serial_statistics_error' => 'Unable to load serial number statistics at this time.',
        'coa_serial_years_query_error' => 'Unable to load available years. Please refresh the page.',
        'coa_hash_generation_error' => 'Unable to generate security hash. Please try again.',
        'coa_traits_hash_error' => 'Unable to process artwork characteristics hash.',
        'coa_hash_verification_error' => 'Security verification failed. Please check the provided data.',
        'coa_multi_hash_error' => 'Unable to generate composite security hash.',
        'coa_multi_hash_verification_error' => 'Composite security verification failed.',
        'coa_file_hash_error' => 'Unable to generate file security hash.',
        'coa_hash_format_validation_error' => 'Invalid security hash format provided.',
        'coa_digital_signature_error' => 'Unable to create digital signature. Please try again.',
        'coa_physical_signature_error' => 'Unable to process physical signature.',
        'coa_digital_signature_verify_error' => 'Digital signature verification failed.',
        'coa_get_signatures_error' => 'Unable to load certificate signatures.',
        'coa_traits_version_create_error' => 'Unable to create artwork characteristics snapshot.',
        'coa_snapshot_create_error' => 'Unable to create certificate snapshot.',
        'coa_snapshot_integrity_check_error' => 'Snapshot integrity verification failed.',
        'coa_issue_certificate_error' => 'Unable to issue the Certificate of Authenticity. Please try again.',
        'coa_reissue_certificate_error' => 'Unable to re-issue the certificate. Please try again.',
        'coa_issue_validation_error' => 'Certificate data validation failed. Please check the form.',
        'coa_revoke_certificate_error' => 'Unable to revoke the certificate. Please try again.',
        'coa_revoke_validation_error' => 'Revocation data validation failed. Please check the form.',
        'coa_revoke_history_error' => 'Unable to load revocation history.',
        'coa_batch_revoke_error' => 'Unable to process multiple certificate revocations.',
        'coa_annex_create_error' => 'Unable to create certificate annex. Please try again.',
        'coa_annex_update_error' => 'Unable to update the annex. Please try again.',
        'coa_get_annexes_error' => 'Unable to load certificate annexes.',
        'coa_bundle_create_error' => 'Unable to create certificate bundle. Please try again.',
        'coa_bundle_estimate_error' => 'Unable to estimate bundle size.',
        'coa_addendum_create_error' => 'Unable to create addendum. Please try again.',
        'coa_policy_create_error' => 'Unable to create policy. Please try again.',
        'coa_get_addendums_error' => 'Unable to load certificate addendums.',
        'coa_get_policies_error' => 'Unable to load active policies.',
        'coa_addendum_integrity_error' => 'Addendum integrity verification failed.',
        'coa_policy_integrity_error' => 'Policy integrity verification failed.',
        'verify_data_generation_error' => 'Unable to generate verification data.',
        'verify_page_generation_error' => 'Unable to load verification page.',
        'verify_public_annexes_error' => 'Unable to load certificate annexes.',
        'verify_qr_generation_error' => 'Unable to generate QR code for verification.',
        'coa_index_error' => 'Unable to load certificates list. Please refresh the page.',
        'coa_show_error' => 'Unable to load certificate details. Please try again.',
        'coa_issue_error' => 'Unable to issue Certificate of Authenticity. Please try again.',
        'coa_reissue_error' => 'Unable to re-issue certificate. Please try again.',
        'coa_revoke_error' => 'Unable to revoke certificate. Please try again.',
        'coa_bundle_error' => 'Unable to generate certificate bundle. Please try again.',
        'coa_statistics_error' => 'Unable to load certificate statistics.',
        'verify_certificate_error' => 'Unable to verify the certificate. Please check the serial number.',
        'verify_page_error' => 'Unable to load verification page. Please try again.',
        'verify_hash_error' => 'Unable to verify the security hash.',
        'verify_annexes_error' => 'Unable to load certificate annexes for verification.',
        'verify_qr_error' => 'Unable to verify QR code. Please try again.',
        'verify_batch_error' => 'Unable to verify multiple certificates at once.',
        'verify_stats_error' => 'Unable to load verification statistics.',
        'annex_index_error' => 'Unable to load annexes list. Please refresh the page.',
        'annex_show_error' => 'Unable to load annex details. Please try again.',
        'annex_create_error' => 'Unable to create annex. Please try again.',
        'annex_update_error' => 'Unable to update annex. Please try again.',
        'annex_history_error' => 'Unable to load annex history.',
        'annex_integrity_error' => 'Annex integrity verification failed.',
        'annex_types_error' => 'Unable to load available annex types.',
        'addendum_list_error' => 'Unable to load addendums list. Please refresh the page.',
        'addendum_not_found' => 'The requested addendum was not found.',
        'addendum_detail_error' => 'Unable to load addendum details. Please try again.',
        'addendum_creation_error' => 'Unable to create addendum. Please try again.',
        'addendum_not_editable' => 'This addendum cannot be edited in its current state.',
        'addendum_update_error' => 'Unable to update addendum. Please try again.',
        'addendum_not_revisable' => 'This addendum cannot be revised in its current state.',
        'addendum_revision_error' => 'Unable to create addendum revision. Please try again.',
        'addendum_not_publishable' => 'This addendum cannot be published in its current state.',
        'addendum_publish_error' => 'Unable to publish addendum. Please try again.',
