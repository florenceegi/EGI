...
return [
    ...
    */
    ...
    'dev' => [
        ...
        // === MINT CONTROLLER ERRORS ===
        'mint_checkout_missing_params' => 'Checkout mint: parametri mancanti. User: :user_id, EGI: :egi_id, Reservation: :reservation_id',
        'mint_checkout_unauthorized' => 'Tentativo checkout mint non autorizzato. User: :user_id non è il vincitore della reservation: :reservation_id (winner: :reservation_user_id)',
        'mint_checkout_invalid_reservation' => 'Checkout mint con reservation non valida. User: :user_id, Reservation: :reservation_id, is_current: :is_current, status: :status, superseded: :superseded_by_id',
        'mint_unauthorized' => 'Tentativo mint non autorizzato. User: :user_id non è il vincitore della reservation: :reservation_id (winner: :reservation_user_id)',
        'mint_invalid_reservation' => 'Mint con reservation non valida. User: :user_id, Reservation: :reservation_id, is_current: :is_current, status: :status',
        'mint_already_minted' => 'Tentativo mint su EGI già mintato. User: :user_id, EGI: :egi_id, Blockchain: :blockchain_id',
        'mint_payment_failed' => 'Pagamento mint fallito. User: :user_id, EGI: :egi_id, Payment: :payment_method, Amount: :amount, Error: :error',
        'mint_validation_error' => 'Errore validazione dati mint. User: :user_id, Errors: :errors',
        'direct_mint_not_available' => 'Direct mint non disponibile. User: :user_id, EGI: :egi_id, Reason: :reason, Availability: :availability',
        'direct_mint_not_available_race' => 'Direct mint non più disponibile (race condition). User: :user_id, EGI: :egi_id, Reason: :reason',
        'direct_mint_already_minted' => 'Tentativo direct mint su EGI già mintato. User: :user_id, EGI: :egi_id, Blockchain: :blockchain_id',
        ...
        'mint_technical_error_treasury' => '⚠️ MINT ERROR: Errore tecnico durante verifica treasury funds. Method: checkTreasuryFunds() not found or failed in AlgorandService. Error type: :error_type, Message: :error_message. User: :user_id, EGI: :egi_id. FIX REQUIRED!',
    ...
    'user' => [
        ...
        // === MINT CONTROLLER ERRORS ===
        'mint_checkout_missing_params' => 'Parametri mancanti per visualizzare il checkout.',
        'mint_checkout_unauthorized' => 'Non sei autorizzato ad accedere a questo checkout.',
        'mint_checkout_invalid_reservation' => 'La prenotazione non è più valida.',
        'mint_unauthorized' => 'Non sei autorizzato a completare questo mint.',
        'mint_invalid_reservation' => 'La prenotazione non è più valida.',
        'mint_already_minted' => 'Questo EGI è già stato mintato.',
        'mint_payment_failed' => 'Il pagamento non è andato a buon fine. Riprova o contatta l\'assistenza.',
        'mint_validation_error' => 'I dati inseriti non sono validi. Controlla e riprova.',
        'direct_mint_not_available' => 'Il mint diretto non è al momento disponibile per questo EGI.',
        'direct_mint_not_available_race' => 'Il mint diretto non è più disponibile. Qualcun altro ha completato l\'acquisto prima di te.',
        'direct_mint_already_minted' => 'Questo EGI è già stato mintato.',
        ...
        'mint_technical_error_treasury' => 'Si è verificato un problema tecnico temporaneo con il sistema blockchain. Il nostro team è stato automaticamente notificato e sta risolvendo. Per favore riprova tra qualche minuto. Il tuo pagamento NON è stato addebitato.',
        ...
        'dual_arch_auto_mint_failed' => 'Errore gestione Auto-Mint. User: :user_id, EGI: :egi_id, Operation: :operation, Error: :error',
        'dual_arch_ai_analysis_failed' => 'Errore richiesta analisi AI NATAN. User: :user_id, EGI: :egi_id, Request: :request_data, Error: :error',
        'dual_arch_promotion_failed' => 'CRITICAL: Promozione EGI blockchain fallita. User: :user_id, EGI: :egi_id, Blockchain: :blockchain, Error: :error',

        // KMS Security Service Errors (Dev)
        'kms_dek_generation_failed' => 'CRITICAL: KMS DEK generation failed. Provider: :provider, KeyId: :key_id, Error: :error',
        'kms_dek_encryption_failed' => 'CRITICAL: KMS DEK encryption failed. Provider: :provider, KeyId: :key_id, Error: :error',
        'kms_dek_decryption_failed' => 'CRITICAL: KMS DEK decryption failed. Provider: :provider, KeyId: :key_id, Error: :error',
        'kms_secure_encrypt_failed' => 'CRITICAL: KMS secure data encryption failed. DataType: :data_type, Size: :data_size, Error: :error',
        'kms_secure_decrypt_failed' => 'CRITICAL: KMS secure data decryption failed. DataType: :data_type, Error: :error',
