...
return [
    ...
    */
    ...
    'dev' => [
        ...
        'egi_minted_cannot_delete' => 'Tentativo eliminazione EGI mintato: utente :user_id su EGI :egi_id (ASA #:token_egi) - BLOCKCHAIN IMMUTABLE, cannot delete',
        ...
        'traits_egi_minted' => 'Tentativo modifica traits su EGI mintato: utente :user_id su EGI :egi_id (ASA #:token_egi) - BLOCKCHAIN IMMUTABLE',
        'utility_egi_minted' => 'Tentativo modifica utility su EGI mintato: utente :user_id su EGI :egi_id (ASA #:token_egi) - BLOCKCHAIN IMMUTABLE',
        'egi_metadata_immutable' => 'Tentativo modifica metadati su EGI mintato: utente :user_id su EGI :egi_id (ASA #:token_egi) - Campi bloccati: :blocked_fields - Solo permesso: :allowed_fields',
        ...
        'coa_issue_unauthenticated' => 'Utente non autenticato per emissione CoA. Timestamp: :timestamp',
    ...
    'user' => [
        ...
        'egi_minted_cannot_delete' => '🔒 Impossibile eliminare questo EGI: è stato certificato su blockchain e i dati sono ora immutabili. Gli EGI mintati non possono essere cancellati.',
        ...
        'traits_egi_minted' => '🔒 Impossibile modificare i traits: questo EGI è stato certificato su blockchain e i dati sono ora immutabili.',
        'utility_egi_minted' => '🔒 Impossibile modificare l\'utility: questo EGI è stato certificato su blockchain e i dati sono ora immutabili.',
        'egi_metadata_immutable' => '🔒 Impossibile modificare titolo, descrizione e metadati: questo EGI è stato certificato su blockchain. Puoi modificare solo il prezzo per dinamiche di mercato.',
        ...
        'coa_issue_unauthenticated' => 'Sessione scaduta. Effettua di nuovo il login per continuare.',
