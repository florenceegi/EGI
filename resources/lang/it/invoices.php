...
return [
    ...
    // Export fields (for CSV headers)
    'export_fields' => [
        'transaction_id' => 'ID Transazione',
        'transaction_date' => 'Data/Ora Transazione',
        'sale_date' => 'Data Vendita',
        'seller_name' => 'Venditore - Nome',
        'seller_email' => 'Venditore - Email',
        'seller_vat' => 'Venditore - P.IVA',
        'seller_fiscal_code' => 'Venditore - Cod.Fiscale',
        'seller_address' => 'Venditore - Indirizzo',
        'seller_city' => 'Venditore - Città',
        'seller_postal_code' => 'Venditore - CAP',
        'seller_country' => 'Venditore - Paese',
        'buyer_name' => 'Acquirente - Nome',
        'buyer_email' => 'Acquirente - Email',
        'buyer_vat' => 'Acquirente - P.IVA',
        'buyer_fiscal_code' => 'Acquirente - Cod.Fiscale',
        'buyer_address' => 'Acquirente - Indirizzo',
        'buyer_city' => 'Acquirente - Città',
        'buyer_postal_code' => 'Acquirente - CAP',
        'buyer_country' => 'Acquirente - Paese',
        'buyer_sdi_code' => 'Acquirente - Codice SDI',
        'buyer_pec' => 'Acquirente - PEC',
        'item_code' => 'Codice Articolo',
        'item_title' => 'Titolo Opera',
        ...
        'blockchain_tx_id' => 'TX Blockchain',
        'nft_asset_id' => 'Asset ID NFT',
    ],
];
