        ...
        'show' => [
            ...
            'sidebar_contexts' => [
                ...
                'guest' => [
                    ...
                    'cta_register' => '<a href="/join" class="inline-block rounded-lg bg-gradient-to-r from-indigo-600 to-purple-600 px-4 py-2 font-semibold text-white hover:opacity-90">Registrati Gratis</a>',
