                    ...
                    <ul className="wheel-menu__mobile-list" role="menu">
                        {items.map((item, index) => (
                            <li key={item.id} role="none">
                                <button
                                    className={`wheel-menu__mobile-item ${selectedId === item.id ? 'wheel-menu__mobile-item--selected' : ''}`}
        ...
        >
            ...
            <ul className="wheel-menu__items" role="menu">
                {items.map((item, index) => (
                    <li
                        key={item.id}
                        className={`wheel-menu__item ${focusedIndex === index ? 'wheel-menu__item--focused' : ''} ${selectedId === item.id ? 'wheel-menu__item--selected' : ''}`}
