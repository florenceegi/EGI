...
class AppConfigController extends Controller
{
    ...
    private function getCollectionTranslationMappings(): array
    {
        return [
            ...
            'create_modal_subtitle' => 'collection.create_modal_subtitle',
            'close_modal' => 'collection.close_modal',
            'creation_success_title' => 'collection.creation_success_title',
            'redirecting_shortly' => 'collection.redirecting_shortly',
            'enter_collection_name' => 'collection.enter_collection_name',
            'name_help_text' => 'collection.name_help_text',
            'minimum_2_characters' => 'collection.minimum_2_characters',
            'loading_stats' => 'collection.loading_stats',
            'create_collection' => 'collection.create_collection',
            'creating' => 'collection.creating',
            'cancel' => 'label.cancel',
            'created_successfully' => 'collection.created_successfully',
            ...
            // Chiavi wallet external (aggiunte per modale)
            'wallet_add_external_description' => 'collection.wallet.add_external_description',
            'wallet_address_hint' => 'collection.wallet.address_hint',
            'wallet_royalty_mint_label' => 'collection.wallet.royalty_mint_label',
            'wallet_royalty_rebind_label' => 'collection.wallet.royalty_rebind_label',
            'wallet_royalty_deduction_warning' => 'collection.wallet.royalty_deduction_warning',
            'wallet_add_button' => 'collection.wallet.add_button',
