...
class EgiliServiceTest extends TestCase {
    ...
    public function it_converts_egili_to_eur_correctly() {
        $this->assertEquals(0.01, $this->service->toEur(1));
        $this->assertEquals(0.10, $this->service->toEur(10));
        $this->assertEquals(5.00, $this->service->toEur(500));
        $this->assertEquals(4.99, $this->service->toEur(499));
    }

    /** @test */
    public function it_converts_eur_to_egili_correctly() {
        $this->assertEquals(10, $this->service->fromEur(0.10));
        $this->assertEquals(100, $this->service->fromEur(1.00));
        $this->assertEquals(5000, $this->service->fromEur(50.00));
        $this->assertEquals(4990, $this->service->fromEur(49.90));
    }
