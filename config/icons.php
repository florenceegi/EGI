    ...
    'styles' => [
        ...
        'elegant' => [
            ...
            [
                ...
                'host' => '',
                'name_on_host' => '',
                'html' => '<span class="material-icons %class%">folder_special</span>',
            ],
            [
                'name' => 'cloud_download',
                'type' => 'material',
                ...
                'host' => '',
                'name_on_host' => '',
                'html' => '<span class="material-icons %class%">cloud_download</span>',
            ],
            [
                'name' => 'search',
                'type' => 'material',
                ...
                'host' => '',
                'name_on_host' => '',
                'html' => '<span class="material-icons %class%">search</span>',
            ],
            [
                'name' => 'pa-ai-costs',
                'type' => 'material',
                ...
                'host' => '',
                'name_on_host' => '',
                'html' => '<span class="material-icons %class%">payments</span>',
            ],
            [
                'name' => 'bar_chart',
                'type' => 'material',
                ...
                'host' => '',
                'name_on_host' => '',
                'html' => '<span class="material-icons %class%">bar_chart</span>',
            ],
            [
                'name' => 'auto_mode',
                'type' => 'material',
                ...
                'host' => '',
                'name_on_host' => '',
                'html' => '<span class="material-icons %class%">auto_mode</span>',
            ],
            [
                'name' => 'pa-acts-list',
                'type' => 'heroicon',
            ...
            // ═══════════════════════════════════════════════════════════════
            // SUPERADMIN ICONS - GOLD THEME (#D4AF37, #FFD700)
            // ═══════════════════════════════════════════════════════════════
            [
                ...
                'host' => '',
                'name_on_host' => '',
                'html' => '<svg fill="#D4AF37" viewBox="0 0 24 24" class="%class%">
                        <path d="M11.47 3.84a.75.75 0 011.06 0l8.69 8.69a.75.75 0 101.06-1.06l-8.689-8.69a2.25 2.25 0 00-3.182 0l-8.69 8.69a.75.75 0 001.061 1.06l8.69-8.69z" />
                        <path d="M12 5.432l8.159 8.159c.03.03.06.058.091.086v6.198c0 1.035-.84 1.875-1.875 1.875H15a.75.75 0 01-.75-.75v-4.5a.75.75 0 00-.75-.75h-3a.75.75 0 00-.75.75V21a.75.75 0 01-.75.75H5.625a1.875 1.875 0 01-1.875-1.875v-6.198a2.29 2.29 0 00.091-.086L12 5.43z" />
                    </svg>',
            ],
            [
                'name' => 'superadmin-ai-brain',
                'type' => 'heroicon',
                'class' => 'w-5 h-5',
                'host' => '',
                'name_on_host' => '',
                'html' => '<svg fill="#FFD700" viewBox="0 0 24 24" class="%class%">
            ...
            [
                ...
                'name_on_host' => '',
                'html' => '<svg fill="#FFD700" viewBox="0 0 24 24" class="%class%">
                        <path fill-rule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zM9 7.5A.75.75 0 009 9h1.5c.98 0 1.813.626 2.122 1.5H9A.75.75 0 009 12h3.622a2.251 2.251 0 01-2.122 1.5H9a.75.75 0 00-.53 1.28l3 3a.75.75 0 101.06-1.06L10.8 14.988A3.752 3.752 0 0014.175 12H15a.75.75 0 000-1.5h-.825A3.733 3.733 0 0013.5 9.01V8.5a.75.75 0 00-1.5 0v.51A3.752 3.752 0 009 7.5z" clip-rule="evenodd" />
                    </svg>',
            ],
            [
                'name' => 'superadmin-equilibrium',
                'type' => 'heroicon',
                'class' => 'w-5 h-5',
                'host' => '',
                'name_on_host' => '',
            ...
            // PADMIN ANALYZER ICONS
            [
                'name' => 'superadmin-padmin-violations',
                'type' => 'heroicon',
                'class' => 'w-5 h-5',
                'host' => '',
                'name_on_host' => '',
            ...
            [
                'name' => 'superadmin-padmin-symbols',
                'type' => 'heroicon',
                'class' => 'w-5 h-5',
                'host' => '',
                'name_on_host' => '',
