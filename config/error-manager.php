...
return [
    ...
    */
    'errors' => [
        ...
        // ====================================================
        'STRIPE_WEBHOOK_SPLIT_FAILED' => [
            'type' => 'critical',
            'blocking' => 'semi-blocking',
            'dev_message_key' => 'error-manager::errors.dev.stripe_webhook_split_failed',
            'user_message_key' => 'error-manager::errors.user.generic_payment_error',
        ...
        'STRIPE_TRANSFER_FAILED' => [
            'type' => 'critical',
            'blocking' => 'semi-blocking', 
            'dev_message_key' => 'error-manager::errors.dev.stripe_transfer_failed',
            'user_message_key' => 'error-manager::errors.user.payment_processing_error',
            'http_status_code' => 500,
            'devTeam_email_need' => true,
            'notify_slack' => true,
            'msg_to' => 'log-only',
        ],
        'STRIPE_SPLIT_PARTIAL_FAILURE' => [
            'type' => 'error',
            'blocking' => 'not',
            'dev_message_key' => 'error-manager::errors.dev.stripe_split_partial_failure',
            'user_message_key' => 'error-manager::errors.user.payment_partially_processed',
            'http_status_code' => 200,
            'devTeam_email_need' => true,
            'notify_slack' => true,
            'msg_to' => 'log-only',
        ],
        'STRIPE_SPLIT_CRITICAL_FAILURE' => [
            'type' => 'critical',
            'blocking' => 'blocking',
            'dev_message_key' => 'error-manager::errors.dev.stripe_split_critical_failure',
            'user_message_key' => 'error-manager::errors.user.payment_failed_fatal',
            'http_status_code' => 500,
            'devTeam_email_need' => true,
            'notify_slack' => true,
            'msg_to' => 'log-only',
        ...
        'MINT_MISSING_STRIPE_ACCOUNTS' => [
            'type' => 'error',
            'blocking' => 'blocking',
            'dev_message_key' => 'error-manager::errors.dev.mint_missing_stripe_accounts',
            'user_message_key' => 'error-manager::errors.user.configuration_error',
            'http_status_code' => 422,
            'devTeam_email_need' => false,
            'notify_slack' => false,
            'msg_to' => 'sweet-alert',
        ...
        'MINT_INSUFFICIENT_STRIPE_CAPABILITIES' => [
            'type' => 'error',
            'blocking' => 'blocking',
            'dev_message_key' => 'error-manager::errors.dev.mint_insufficient_stripe_capabilities',
            'user_message_key' => 'error-manager::errors.user.configuration_error',
            'http_status_code' => 422,
            'devTeam_email_need' => false,
            'notify_slack' => false,
        ...
        // ====================================================
        'ALGORAND_MINT_FAILED' => [
            'type' => 'critical',
            'blocking' => 'blocking',
            'dev_message_key' => 'error-manager::errors.dev.algorand_mint_failed',
            'user_message_key' => 'error-manager::errors.user.minting_error',
            'http_status_code' => 500,
            'devTeam_email_need' => true,
            'notify_slack' => true,
            'msg_to' => 'log-only', // Background job
        ],
        'EGI_TRANSFER_FAILED' => [
            'type' => 'critical',
            'blocking' => 'blocking',
            'dev_message_key' => 'error-manager::errors.dev.egi_transfer_failed',
            'user_message_key' => 'error-manager::errors.user.transfer_error',
            'http_status_code' => 500,
            'devTeam_email_need' => true,
            'notify_slack' => true,
            'msg_to' => 'log-only',
        ],
        'MINT_DISTRIBUTION_FAILED' => [
            'type' => 'error',
            'blocking' => 'not', // Don't fail the mint, just the record creation
            'dev_message_key' => 'error-manager::errors.dev.mint_distribution_failed',
            'user_message_key' => 'error-manager::errors.user.internal_warning',
            'http_status_code' => 200,
            'devTeam_email_need' => true,
            'notify_slack' => true,
            'msg_to' => 'log-only',
        ...
        'CERTIFICATE_GENERATION_FAILED_POST_MINT' => [
            ...
            'user_message_key' => 'error-manager::errors.user.internal_warning',
            'http_status_code' => 200,
            'devTeam_email_need' => true, // Needs fixing but not critical urgency
            'notify_slack' => true,
            'msg_to' => 'log-only',
        ],
        'EGILI_CREATOR_REWARD_FAILED' => [
            'type' => 'warning',
            'blocking' => 'not',
            'dev_message_key' => 'error-manager::errors.dev.egili_creator_reward_failed',
            'user_message_key' => 'error-manager::errors.user.internal_warning',
            'http_status_code' => 200,
            'devTeam_email_need' => false,
            'notify_slack' => false,
        ...
        'REAL_BLOCKCHAIN_MINT_FAILED' => [
            'type' => 'critical',
            'blocking' => 'blocking',
            'dev_message_key' => 'error-manager::errors.dev.real_blockchain_mint_failed',
            'user_message_key' => 'error-manager::errors.user.minting_error',
            'http_status_code' => 500,
            'devTeam_email_need' => true,
            'notify_slack' => true,
        ...
        'REAL_BLOCKCHAIN_MINT_FINAL_FAILURE' => [
            'type' => 'critical',
            'blocking' => 'blocking',
            'dev_message_key' => 'error-manager::errors.dev.real_blockchain_mint_final_failure',
            'user_message_key' => 'error-manager::errors.user.minting_fatal_error',
            'http_status_code' => 500,
            'devTeam_email_need' => true,
            'notify_slack' => true,
            'msg_to' => 'log-only', // Alert the world
        ],
        'UCM_UPDATE_FAILED' => [
            'type' => 'critical',
            'blocking' => 'blocking',
        ...
        'COMMERCE_ENABLE_FAILED' => [
            'type' => 'error',
            'blocking' => 'semi-blocking',
            'dev_message_key' => 'error-manager::errors_2.dev.commerce_enable_failed',
            'user_message_key' => 'error-manager::errors_2.user.commerce_enable_failed',
            'http_status_code' => 500,
            'devTeam_email_need' => true,
            'notify_slack' => true,
            'msg_to' => 'sweet-alert',
        ],
        'COMMERCE_SETTINGS_UPDATE_FAILED' => [
            'type' => 'error',
            'blocking' => 'semi-blocking',
            'dev_message_key' => 'error-manager::errors_2.dev.commerce_settings_update_failed',
            'user_message_key' => 'error-manager::errors_2.user.commerce_settings_update_failed',
            'http_status_code' => 500,
            'devTeam_email_need' => true,
            'notify_slack' => true,
            'msg_to' => 'sweet-alert',
        ...
        'STRIPE_CONNECT_ACCOUNT_FAILED' => [
            'type' => 'error',
            'blocking' => 'semi-blocking',
            'dev_message_key' => 'stripe.errors.dev.connect_account_failed',
            'user_message_key' => 'stripe.errors.user.connect_account_failed',
            'http_status_code' => 500,
            'devTeam_email_need' => true,
            'notify_slack' => true,
            'msg_to' => 'toast',
        ],
        'STRIPE_CONNECT_ACCOUNT_LINK_FAILED' => [
            'type' => 'warning',
            'blocking' => 'not',
            'dev_message_key' => 'stripe.errors.dev.connect_account_link_failed',
            'user_message_key' => 'stripe.errors.user.connect_account_link_failed',
            'http_status_code' => 400,
            'devTeam_email_need' => false,
            'notify_slack' => false,
            'msg_to' => 'toast',
        ],
        'STRIPE_CONNECT_ACCOUNT_RETRIEVE_FAILED' => [
            'type' => 'warning',
            'blocking' => 'not',
            'dev_message_key' => 'stripe.errors.dev.connect_account_retrieve_failed',
            'user_message_key' => 'stripe.errors.user.connect_account_retrieve_failed',
            'http_status_code' => 400,
            'devTeam_email_need' => false,
            'notify_slack' => false,
            'msg_to' => 'toast',
        ],
        'STRIPE_MERCHANT_ACCOUNT_DISABLED' => [
            'type' => 'error',
            'blocking' => 'blocking',
            'dev_message_key' => 'error-manager::errors_2.dev.stripe_merchant_account_disabled',
            'user_message_key' => 'error-manager::errors_2.user.stripe_merchant_account_disabled',
            'http_status_code' => 503,
            'devTeam_email_need' => false,
            'notify_slack' => true,
            'msg_to' => 'toast',
        ],
        'STRIPE_MERCHANT_ACCOUNT_INCOMPLETE' => [
            'type' => 'warning',
            'blocking' => 'semi-blocking',
            'dev_message_key' => 'error-manager::errors_2.dev.stripe_merchant_account_incomplete',
            'user_message_key' => 'error-manager::errors_2.user.stripe_merchant_account_incomplete',
            'http_status_code' => 503,
            'devTeam_email_need' => false,
            'notify_slack' => true,
            'msg_to' => 'toast',
        ],
        'MINT_NO_WALLETS_CONFIGURED' => [
            'type' => 'error',
            'blocking' => 'blocking',
            'dev_message_key' => 'error-manager::errors_2.dev.mint_no_wallets_configured',
            'user_message_key' => 'error-manager::errors_2.user.mint_no_wallets_configured',
            'http_status_code' => 500,
            'devTeam_email_need' => true,
            'notify_slack' => true,
            'msg_to' => 'toast',
        ],
        'MINT_INVALID_PERCENTAGES' => [
            'type' => 'error',
            'blocking' => 'blocking',
            'dev_message_key' => 'error-manager::errors_2.dev.mint_invalid_percentages',
            'user_message_key' => 'error-manager::errors_2.user.mint_invalid_percentages',
            'http_status_code' => 500,
            'devTeam_email_need' => true,
            'notify_slack' => true,
            'msg_to' => 'toast',
        ...
        'MINT_MISSING_STRIPE_ACCOUNTS' => [
            'type' => 'error',
            'blocking' => 'blocking',
            'dev_message_key' => 'error-manager::errors_2.dev.mint_missing_stripe_accounts',
            'user_message_key' => 'error-manager::errors_2.user.mint_missing_stripe_accounts',
            'http_status_code' => 503,
            'devTeam_email_need' => true,
            'notify_slack' => true,
            'msg_to' => 'toast',
        ...
        'STRIPE_TRANSFER_REVERSAL_FAILED' => [
            'type' => 'critical',
            'blocking' => 'blocking',
            'dev_message_key' => 'error-manager::errors_2.dev.stripe_transfer_reversal_failed',
            'user_message_key' => 'error-manager::errors_2.user.stripe_transfer_reversal_failed',
            'http_status_code' => 500,
            'devTeam_email_need' => true,
            'notify_slack' => true,
            'msg_to' => 'toast',
        ],
        'SPLIT_PAYMENT_MISSING_CONSENTS' => [
            'type' => 'error',
            'blocking' => 'blocking',
            'dev_message_key' => 'error-manager::errors_2.dev.split_payment_missing_consents',
            'user_message_key' => 'error-manager::errors_2.user.split_payment_missing_consents',
            'http_status_code' => 403,
            'devTeam_email_need' => true,
            'notify_slack' => true,
            'msg_to' => 'toast',
