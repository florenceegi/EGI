...
export default {
    darkMode: "class", // Abilita dark mode con classe oppure 'media' per seguire sistema
    content: [
    ...
    daisyui: {
        ...
        themes: [
            {
                florenceegi: {
                    // Il nostro tema custom per DaisyUI
    ...
    safelist: [
        ...
        "shadow-[0_0_0_1px_rgba(255,255,255,0.08),0_0_12px_-2px_rgba(14,165,233,0.5)]",
        'before:content-[""]',
        "before:absolute",
        "before:inset-0",
        ...
        "after:absolute",
        "after:-inset-1",
        "after:bg-[repeating-linear-gradient(45deg,rgba(255,255,255,0.08)_0_6px,transparent_6px_12px)]",
        "after:opacity-40",
        "after:animate-[pulse_5s_ease-in-out_infinite]",
